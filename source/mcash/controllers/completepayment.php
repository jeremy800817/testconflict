...
echo $payload;
    ...
    if ($channel = "GOPAYZ") {
        $publicKey = new AsymmetricPublicKey(file_get_contents("C:\Users\HP\Downloads\Gopayz\gopayz\controllers\key\privatersa.pem"));
       // echo $res;
     //   $privateKey = new AsymmetricSecretKey(sodium_crypto_sign_keypair());
       // $publicKey = $_SESSION['publicKey'];
      //  echo $_SESSION['publicKey']->toString();

        $token = Version1::verify($payload, $publicKey);

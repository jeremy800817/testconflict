...
<body class="gogold">
	...
	<div class="language-switcher"> 
		...
		<li class="active"><?php echo $lang['HI'] ?> <?php echo $_SESSION['displayname'] ?></li>
			<li class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'en') || !isset($_SESSION['lang']) ? 'active' : ''; ?>"><a href="dashboard-buy-gold-confirm-fpx.php?lang=en">Eng</a></li>
			<li class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'bm') ? 'active' : ''; ?>"><a href="dashboard-buy-gold-confirm-fpx.php?lang=bm">BM</a></li>
		</ul>
	</div>
	<div class="header">
		<div class="hero">
		...
		<div class="page-content-box">
			...
			<div class="main-widget">
				...
				<div class="table-row">
					...
					<div class="col value">RM <?php echo  number_format($_SESSION['amount'],2)  ?></div>
				</div>
				<div class="table-row">
			...
			<div class="main-widget">
				...
				<form id="callpayform" method="post" action="controllers\callfpx.php" onsubmit="return validate();">
					<div class="form-row">
						<div class="form-col center limit2">
					...
					<div class="form-row submit">
						<div class="form-col">
							...
							<input id="buttonconfirm" class="btn " formaction="controllers\callfpx.php" value="<?php echo $lang['SUBMIT']; ?>" type="button" onclick="this.disabled=true;this.form.submit();">
				...
				<div class="form-row">
					...
					<a class="btn" id="reflesh" href="dashboard-buy-gold-confirm-fpx.php"><?php echo $lang['REFRESH']; ?></button></a>
					</div>
				</div>

...
(function(){
  ...
  setInterval(function() {
	...
	document.getElementById("customerbuycountdown").style.color = "#e52d27";
    //    alert('this is where it happens');

	//window.location = 'dashboard-buy-gold.php';
    $("#buttonconfirm").hide();
	//$("#btnpaywallet").hide();
	$("#btnpaywallet").hide();
	$("#reflesh").show();
...
<title><?php echo $lang['BUY_GOLD_CONFIRM_TITLE'] ?></title>
...
<body class="gogold">
	...
	<div class="language-switcher"> 
		...
		<li class="active"><?php echo $lang['HI'] ?> <?php echo $_SESSION['displayname'] ?></li>
			<li class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'en') || !isset($_SESSION['lang']) ? 'active' : ''; ?>"><a href="dashboard-buy-gold-confirm-wallet.php?lang=en">Eng</a></li>
			<li class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'bm') ? 'active' : ''; ?>"><a href="dashboard-buy-gold-confirm-wallet.php?lang=bm">BM</a></li>
		</ul>
	</div>
	<div class="header">
		<div class="hero">
	...
	<div class="header-inside">
		...
		<a class="back" href="dashboard-buy-gold.php"></a>
	</div>
	...
	<div class="page-content">
		...
		<div class="page-content-box">
			...
			<div class="main-widget">
				...
				<div class="table-row">
					<div class="col label"><?php echo $lang['PURCHASEPRICE']; ?> <span class="unit">Unit price</span></div>
					<div class="col value">RM <?php echo  number_format($_SESSION['unit_price'], 2)  ?> / gram</div>
				</div>
				<div class="table-row">
					<div class="col label"><?php echo $lang['FEES']; ?></div>
					<div class="col value">RM <?php echo  number_format($_SESSION['wallet_fee'], 2)  ?></div>
				</div>
				<div class="table-row">
					<div class="col label"><?php echo $lang['TOTALBUY']; ?></div>
					<div class="col value">RM <?php echo  number_format($_SESSION['original_total'],2)  ?></div>
				</div>
				<div class="table-row">
				...
				<div class="table-row total">
					...
					<div class="value">RM  <?php echo  number_format($_SESSION['total_wallet'], 2)     ?></div>
				</div>
			</div>
			...
			<div class="main-widget">
				...
				<form id="callpayform" method="post" action="dashboard-buy-gold-redirect-wallet.php" onsubmit="return validate();">
					<div class="form-row">
						<div class="form-col center limit2">
							<label><?php echo $lang['CAMPAIGN_CODE']; ?></label>
								<input id="buycampaigncode" type="text" placeholder="(Optional)" name="buycampaigncode" />
					...
					<div class="form-row submit">
						<div class="form-col">
							...
							<input id="buttonconfirm" class="btn " formaction="controllers\callwallet.php" value="<?php echo $lang['SUBMIT']; ?>" type="button" onclick="this.disabled=true;this.form.submit();">
							<input id="formtype" type="hidden" name="formtype" value="BUY">
						</div>
					</div>
				</form>
				<div class="form-row">
					<div class="form-col center">
						<a class="btn" id="reflesh" href="dashboard-buy-gold-confirm-wallet.php"><?php echo $lang['REFRESH']; ?></button></a>
					</div>
				</div>

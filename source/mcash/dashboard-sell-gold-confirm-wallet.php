...
<body class="gogold">
	...
	<div class="language-switcher"> 
		<ul>
            ...
            <li class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'en') || !isset($_SESSION['lang']) ? 'active' : ''; ?>"><a href="dashboard-sell-gold-confirm-wallet.php?lang=en">Eng</a></li>
			<li class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'bm') ? 'active' : ''; ?>"><a href="dashboard-sell-gold-confirm-wallet.php?lang=bm">BM</a></li>
        </ul>
	</div>
	<div class="header">
		<div class="hero">
	...
	<div class="page-content">
		...
		<div class="page-content-box">
			...
			<div class="main-widget">
				...
				<form id="callpayform" method="post" action="dashboard-sell-gold-redirect-wallet.php" onsubmit="return validate();">
					<div class="form-row">
						<div class="form-col center limit2">
					...
					<div class="form-row submit">
						<div class="form-col">
							...
							<input id="buttonconfirm" class="btn " formaction="dashboard-sell-gold-redirect-wallet.php" value="<?php echo $lang['SUBMIT']; ?>" type="button" onclick="this.disabled=true;this.form.submit();">
				...
				<div class="form-row">
					<div class="form-col center">
						<a class="btn" id="reflesh" href="dashboard-sell-gold-confirm-wallet.php"><?php echo $lang['REFRESH']; ?></button></a>
					</div>
				</div>

...
<title><?php echo $lang['SELL_GOLD_RECEIPT_TITLE'] ?></title>
...
<body class="gogold">
	...
	<div class="language-switcher"> 
		...
		<li class="active"><?php echo $lang['HI'] ?> <?php echo $_SESSION['displayname'] ?></li>
			<li class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'en') || !isset($_SESSION['lang']) ? 'active' : ''; ?>"><a href="dashboard-sell-gold-receipt.php?lang=en">Eng</a></li>
			<li class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'bm') ? 'active' : ''; ?>"><a href="dashboard-sell-gold-receipt.php?lang=bm">BM</a></li>
		</ul>
	</div>
	<div class="header">
		<div class="hero">
	...
	<div class="header-inside">
		...
		<a class="back" href="dashboard-sell-gold.php">Back</a>
	</div>

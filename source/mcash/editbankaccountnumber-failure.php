...
<?php include_once('controllers/config/db.php'); ?>
<?php include_once('common.php');  ?>

<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<title><?php echo $lang['TITLE_FAILED_BANK_DETAIL_EDIT'];?></title>
...
<!-- <link rel="stylesheet" type="text/css" href="css/style-onecall.css"> -->
...
<body class="gogold">
	<?php //include 'components/nav-script.php' ?>
	...
	<div class="language-switcher"> 
		...
		<li class="active"><?php echo $lang['HI'] ?> <?php echo $_SESSION['displayname'] ?></li>
			<li class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'en') || !isset($_SESSION['lang']) ? 'active' : ''; ?>"><a href="edit-profile-failure.php?lang=en">Eng</a></li>
			<li class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'bm') ? 'active' : ''; ?>"><a href="edit-profile-failure.php?lang=bm">BM</a></li>
		</ul>
	</div>
	<div class="header">
		<div class="hero">
		...
		<div class="page-content-box">
			...
			<div class="page-content-form">
				...
				<div class="page-title">
					<?php echo $lang['FailedBankEdit']; ?>
				</div>
							
							
				<div class="form-title center">
				<?php echo $_SESSION['edit_bank_error_message']; ?>
				</div>

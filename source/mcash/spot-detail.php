...
<body class="gogold">
	...
	<div class="language-switcher"> 
		...
		<li class="active"><?php echo $lang['HI'] ?> <?php echo $_SESSION['displayname'] ?></li>
			<li class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'en') || !isset($_SESSION['lang']) ? 'active' : ''; ?>"><a href="spot-detail.php?lang=en">Eng</a></li>
			<li class="<?php echo (isset($_SESSION['lang']) && $_SESSION['lang'] == 'bm') ? 'active' : ''; ?>"><a href="spot-detail.php?lang=bm">BM</a></li>
		</ul>
	</div>
	<div class="header">
		<div class="hero">
		...
		<div class="page-content-box">
			...
			<div class="main-widget">
				<div class="table-row title">
					...
					<?php echo $lang['TransactionDetail'] ?>
				</div>
				<div class="table-row">
					<div class="col label">ID</div>
					<div class="col value"><?php echo $payload['transactionid']; ?></div>
				</div>
				<div class="table-row">
					<div class="col label"><?php echo $lang['Date']; ?></div>
					<div class="col value"><?php echo date('d M Y h:i A', strtotime($payload['date'])); ?></div>
				</div>
				<div class="table-row">
				...
				<div class="table-row">
					<div class="col label"><?php echo $lang['Gold_Purchase']; ?><span class="unit">Gram</span></div>
					<div class="col value"><?php echo number_format($payload['weight'], 3); ?></div>
				</div>
				<div class="table-row">
					<div class="col label"><?php echo $payload['type'] == 'buy' ? $lang['PURCHASEPRICE'] : $lang['SELLPRICE'];?> <span class="unit"><?php echo $lang['UnitPrice'];?></span></div>
					<div class="col value">RM <?php echo number_format($payload['price'], 2); ?></div>
				</div>
				<div class="table-row">
				...
				<div class="table-row">
					<div class="col label"><?php echo $payload['type'] == 'buy' ? $lang['TOTALBUY'] : $lang['TOTALSELL'] ?></div>
					<div class="col value">RM <?php echo  number_format($payload['amount'],2)  ?></div>
				</div>
				<div class="table-row">
				...
				<div class="table-row">
					...
					<div class="col value">SG4S, Malaysia<br /><?php echo $lang['asStorageProvider']; ?></div>
				</div>
				<div class="table-row total">
					<div class="label"><?php echo $lang['FinalTotal'];?></div>
					<div class="value">RM <?php echo $payload['type'] == 'buy' ? number_format(($payload['amount'] + $payload['transaction_fee']), 2) : number_format($payload['amount'] - $payload['transaction_fee'], 2); ?></div>
				</div>
				<div class="table-row">

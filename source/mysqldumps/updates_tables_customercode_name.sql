-- Changes to tables to cater for customercode and customername 
-- tables changed are of the following :
-- myaccountholder
-- mypaymentdetail
-- mydisbursement
-- vw_mygoldtransaction
-- vw_disbursement
-- vw_paymentdetail
-- vw_myconversion
...
CREATE TABLE IF NOT EXISTS `myaccountholder` (
  ...
  `ach_mykadno` varchar(12) NOT NULL,
  `ach_phoneno` varchar(15) NOT NULL,
  ...
  `ach_nokbankid` bigint(20) DEFAULT NULL,
  `ach_nokaccountnumber` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `mydisbursement`
--
...
CREATE TABLE IF NOT EXISTS `mydisbursement` (
  ...
  `dbm_requestedon` datetime NOT NULL,
  `dbm_disbursedon` datetime DEFAULT NULL,
  `dbm_verifiedamount` decimal(20,6) NOT NULL,

...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&air=1&code=INTLX.AIRGOLD';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&air=1&code=INTLX.AIRGOLD';
// }
Ext.define('snap.store.AirSalesPriceStream', {
	...
	alias: 'store.AirSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'airsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'airsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('airsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('airsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('airsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('airspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('airspotsaleacesell').setValue(aceselldesign);

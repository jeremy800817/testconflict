...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&bsn=1&code=INTLX.BSN';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&onecall=1&code=INTLX.ONECALL';
// }
Ext.define('snap.store.BsnSalesPriceStream', {
	...
	alias: 'store.BsnSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'bsnsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'bsnsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('bsnsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('bsnsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('bsnsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('bsnspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('bsnspotsaleacesell').setValue(aceselldesign);

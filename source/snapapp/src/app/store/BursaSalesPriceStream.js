...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&bursa=1&code=INTLX.Bursa';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&onecall=1&code=INTLX.ONECALL';
// }
Ext.define('snap.store.BursaSalesPriceStream', {
	...
	alias: 'store.BursaSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'bursasalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'bursasalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('bursasaleacesellprice').setValue(companysellppg);
					Ext.getCmp('bursasaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('bursasaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('bursaspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('bursaspotsaleacesell').setValue(aceselldesign);

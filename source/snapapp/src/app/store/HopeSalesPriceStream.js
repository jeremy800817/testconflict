...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&code=INTLX.HOPEGOLD';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&gopayz=1&code=INTLX.GOPAYZ';
// }
Ext.define('snap.store.HopeSalesPriceStream', {
	...
	alias: 'store.HopeSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'hopesalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'hopesalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('hopesaleacesellprice').setValue(companysellppg);
					Ext.getCmp('hopesaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('hopesaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('hopespotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('hopespotsaleacesell').setValue(aceselldesign);

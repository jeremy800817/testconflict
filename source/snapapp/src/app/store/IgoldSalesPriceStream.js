...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&igold=1&code=INTLX.IGOLD';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&onecall=1&code=INTLX.ONECALL';
// }
Ext.define('snap.store.IgoldSalesPriceStream', {
	...
	alias: 'store.IgoldSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'igoldsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'igoldsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('igoldsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('igoldsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('igoldsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('igoldspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('igoldspotsaleacesell').setValue(aceselldesign);

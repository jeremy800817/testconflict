...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&code=INTLX.KASIH';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&gopayz=1&code=INTLX.GOPAYZ';
// }
Ext.define('snap.store.KasihSalesPriceStream', {
	...
	alias: 'store.KasihSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'kasihsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'kasihsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('kasihsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('kasihsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('kasihsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('kasihspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('kasihspotsaleacesell').setValue(aceselldesign);

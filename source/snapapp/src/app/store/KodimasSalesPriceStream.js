...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&code=INTLX.KODIMAS';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&gopayz=1&code=INTLX.GOPAYZ';
// }
Ext.define('snap.store.KodimasSalesPriceStream', {
	...
	alias: 'store.KodimasSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'kodimassalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'kodimassalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('kodimassaleacesellprice').setValue(companysellppg);
					Ext.getCmp('kodimassaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('kodimassaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('kodimasspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('kodimasspotsaleacesell').setValue(aceselldesign);

...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&code=INTLX.pkb';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&gopayz=1&code=INTLX.GOPAYZ';
// }
Ext.define('snap.store.kopetroSalesPriceStream', {
	...
	alias: 'store.kopetroSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'kopetrosalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'kopetrosalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('ktpsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('ktpsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('ktpsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('ktpspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('ktpspotsaleacesell').setValue(aceselldesign);

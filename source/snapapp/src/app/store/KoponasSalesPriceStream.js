...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&code=INTLX.KIGA';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&gopayz=1&code=INTLX.GOPAYZ';
// }
Ext.define('snap.store.KoponasSalesPriceStream', {
	...
	alias: 'store.KoponasSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'koponassalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'koponassalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('koponassaleacesellprice').setValue(companysellppg);
					Ext.getCmp('koponassaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('koponassaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('koponasspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('koponasspotsaleacesell').setValue(aceselldesign);

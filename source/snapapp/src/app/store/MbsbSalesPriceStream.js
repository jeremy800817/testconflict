...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&code=INTLX.MBSB';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&gopayz=1&code=INTLX.GOPAYZ';
// }
Ext.define('snap.store.MbsbSalesPriceStream', {
	...
	alias: 'store.MbsbSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'mbsbsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'mbsbsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('mbsbsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('mbsbsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('mbsbsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('mbsbspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('mbsbspotsaleacesell').setValue(aceselldesign);

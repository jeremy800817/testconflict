...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&noor=1&code=INTLX.THENOOR';
// var host_name = window.location.host;
// if (host_name.search('demo') >= 0 || host_name.search('uat') >= 0 ){
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&noor=1&code=INTLX.NOOR';
// }else{
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&noor=1&code=INTLX.NOOR';
// }
Ext.define('snap.store.NoorSalesPriceStream', {
	...
	alias: 'store.NoorSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'noorsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'noorsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('noorsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('noorsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('noorsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('noorspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('noorspotsaleacesell').setValue(aceselldesign);

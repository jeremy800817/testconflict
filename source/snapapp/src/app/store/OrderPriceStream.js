...
var timer = 0;
var timer2 = 0;
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribe&pdt=DG-999-9'
// var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += 'bo.gtp.development' + '/nchan/sub/2'
// var websocketurl = 'wss://gtp2uat.ace2u.com/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&onecent=1&code=INTLX.GTP_T1';

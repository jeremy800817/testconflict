...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&code=INTLX.PITIHEMAS';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&gopayz=1&code=INTLX.GOPAYZ';
// }
Ext.define('snap.store.pkbaffiSalesPriceStream', {
	...
	alias: 'store.pkbaffiSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'pkbaffiSalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'pkbaffiSalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('pkbaffisaleacesellprice').setValue(companysellppg);
					Ext.getCmp('pkbaffisaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('pkbaffisaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('pkbaffispotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('pkbaffispotsaleacesell').setValue(aceselldesign);

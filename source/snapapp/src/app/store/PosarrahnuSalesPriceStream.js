...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&posarrahnu=1&code=INTLX.POSARRAHNUGOLD';
// var host_name = window.location.host;
// if (host_name.search('demo') >= 0 || host_name.search('uat') >= 0 ){
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&onecall=1&code=INTLX.ONECALL';
// }else{
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&onecall=1&code=INTLX.ONECALL';
// }
Ext.define('snap.store.PosarrahnuSalesPriceStream', {
	...
	alias: 'store.PosarrahnuSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'posarrahnusalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'posarrahnusalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('posarrahnusaleacesellprice').setValue(companysellppg);
					Ext.getCmp('posarrahnusaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('posarrahnusaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('posarrahnuspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('posarrahnuspotsaleacesell').setValue(aceselldesign);

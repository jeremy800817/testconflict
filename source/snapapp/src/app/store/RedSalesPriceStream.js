...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&code=INTLX.REDGOLD';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&gopayz=1&code=INTLX.GOPAYZ';
// }
Ext.define('snap.store.RedSalesPriceStream', {
	...
	alias: 'store.RedSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'redsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'redsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('redsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('redsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('redsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('redspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('redspotsaleacesell').setValue(aceselldesign);

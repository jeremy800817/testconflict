...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&code=INTLX.TOYYIBPAY';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&gopayz=1&code=INTLX.GOPAYZ';
// }
Ext.define('snap.store.ToyyibSalesPriceStream', {
	...
	alias: 'store.ToyyibSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'toyyibsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'toyyibsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('toyyibsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('toyyibsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('toyyibsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('toyyibspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('toyyibspotsaleacesell').setValue(aceselldesign);

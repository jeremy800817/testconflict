...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&code=INTLX.ANNUARGOLD';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&gopayz=1&code=INTLX.GOPAYZ';
// }
Ext.define('snap.store.WaqafSalesPriceStream', {
	...
	alias: 'store.WaqafSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'waqafsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'waqafsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('waqafsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('waqafsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('waqafsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('waqafspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('waqafspotsaleacesell').setValue(aceselldesign);

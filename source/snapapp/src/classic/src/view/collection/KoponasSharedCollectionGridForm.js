Ext.define('snap.view.collection.KoponasSharedCollectionGridForm', {
    extend: 'snap.view.gridpanel.GridForm',
    alias: 'widget.KoponasSharedCollectionGridForm',
    requires: [
        'Ext.panel.Panel',
        'Ext.window.Window',
        'Ext.form.*',
                            ...
                            },
                            {
                                ...
                                bind:{
                                    store: {
                                        ...
                                        proxy: {
                                            type: 'ajax',	       	
                                            url: 'index.php?hdl=collection&action=getSharedBranchList&partnercode=KOPONAS',		
                                            reader: {
                                                type: 'json',

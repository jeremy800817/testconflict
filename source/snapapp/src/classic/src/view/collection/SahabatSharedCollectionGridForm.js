Ext.define('snap.view.collection.SahabatSharedCollectionGridForm', {
    extend: 'snap.view.gridpanel.GridForm',
    alias: 'widget.SahabatSharedCollectionGridForm',
    requires: [
        'Ext.panel.Panel',
        'Ext.window.Window',
        'Ext.form.*',
                            ...
                            },
                            {
                                ...
                                bind:{
                                    store: {
                                        ...
                                        proxy: {
                                            type: 'ajax',	       	
                                            url: 'index.php?hdl=collection&action=getSharedBranchList&partnercode=SAHABAT',		
                                            reader: {
                                                type: 'json',

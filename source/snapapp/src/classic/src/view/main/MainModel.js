...
Ext.define('snap.view.main.MainModel', {
    ...
    menuItems: [
        ...
        { text: 'TEKUN BUYBACK', iconCls: 'x-fa fa-university', selectable: false,
            children: [
                { text: 'Buyback', iconCls: 'x-fa fa-shopping-basket', leaf: true, viewType: 'tekunbuybackview', permission: '/root/tekun/buyback/list' },
                { text: 'Tender / Auction', iconCls: 'x-fa fa-shopping-basket', leaf: true, viewType: 'tekuntenderview', permission: '/root/tekun/tender/list' },
                { text: 'Collection / GRN', iconCls: 'x-fa fa-shopping-basket', leaf: true, viewType: 'tekuncollectionview', permission: '/root/tekun/collection/list' },
            ]
        },
        { text: 'KOPONAS BUYBACK', iconCls: 'x-fa fa-university', selectable: false,
            children: [
                { text: 'Buyback', iconCls: 'x-fa fa-shopping-basket', leaf: true, viewType: 'koponasbuybackview', permission: '/root/koponas/buyback/list' },
                { text: 'Tender / Auction', iconCls: 'x-fa fa-shopping-basket', leaf: true, viewType: 'koponastenderview', permission: '/root/koponas/tender/list' },
                { text: 'Collection / GRN', iconCls: 'x-fa fa-shopping-basket', leaf: true, viewType: 'koponascollectionview', permission: '/root/koponas/collection/list' },
            ]
        },
        { text: 'SAHABAT BUYBACK', iconCls: 'x-fa fa-university', selectable: false,
            children: [
                { text: 'Buyback', iconCls: 'x-fa fa-shopping-basket', leaf: true, viewType: 'sahabatbuybackview', permission: '/root/sahabat/buyback/list' },
                { text: 'Tender / Auction', iconCls: 'x-fa fa-shopping-basket', leaf: true, viewType: 'sahabattenderview', permission: '/root/sahabat/tender/list' },
                { text: 'Collection / GRN', iconCls: 'x-fa fa-shopping-basket', leaf: true, viewType: 'sahabatcollectionview', permission: '/root/sahabat/collection/list' },
            ]
        },
        ...
        { text: 'NOOR', iconCls: 'x-fa fa-university', selectable: false,
            children: [
                { text: 'Spot Orders', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'noororderview', permission: '/root/noor/goldtransaction/list' },
                { text: 'Price Alert', iconCls: 'x-fa fa-clock', leaf: true, viewType: 'noorpricealertview', permission: '/root/noor/pricealert/list' },
                //{ text: 'Reversal', iconCls: 'x-fa fa-undo', leaf: true, viewType: 'reversalview', permission: '' },
                //{ text: 'Disbursement', iconCls: 'x-fa fa-bell', leaf: true, viewType: 'mydisbursementview', permission: '/root/noor/disbursement/list' },
                { text: 'Conversion', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'noorconversionview', permission: '/root/noor/redemption/list' },
                { text: 'Logistic', iconCls: 'x-fa fa-truck', leaf: true, viewType: 'noorlogisticview', permission: '/root/noor/logistic/list' },
                { text: 'Account Holder', iconCls: 'x-fa fa-id-card', leaf: true, viewType: 'myaccountholdernoorview', permission: '/root/noor/profile/list' },
                { text: 'Account Closure', iconCls: 'x-fa fa-eraser', leaf: true, viewType: 'mynooraccountclosureview', permission: '/root/noor/accountclosure/list' },
                { text: 'User Profile', iconCls: 'x-fa fa-id-card', visible: false, leaf: true, viewType: 'mynoorcifview', permission: '/root/noor/profile/list', },
                // { text: 'Vault', iconCls: 'x-fa fa-warehouse', leaf: true, viewType: 'mygovaultitem-border', permission: '/root/noor/vault/list'},
                //{ text: 'Dashboard', iconCls: 'x-fa fa-bars', leaf: true, viewType: 'mygoldbarstatusview', permission: '/root/bmmb/goldbarstatus/list' },
                // { text: 'Approval', iconCls: 'x-fa fa-truck', leaf: true, viewType: 'myaccountholderforpepview', permission: '/root/bmmb/approval/list' },
                //{ text: 'FPX', iconCls: 'x-fa fa-truck', leaf: true, viewType: 'mypaymentdetailview', permission: '/root/bmmb/fpx/list' },
                //{ text: 'Push Notification', iconCls: 'x-fa fa-bell', leaf: true, viewType: 'mygopushnotificationview', permission: '/root/noor/pushnotification/list' },

                //{ text: 'Bank', iconCls: 'x-fa fa-bell', leaf: true, viewType: 'mybankview', permission: '/root/bmmb/profile/list' },
                { text: 'Gold Transfer', iconCls: 'x-fa fa-arrows-alt-h', leaf: true, viewType: 'mytransfergoldnoorview', permission: '/root/noor/transfergold/list' },
                { text: 'Promo', iconCls: 'x-fa fa-rocket', leaf: true, viewType: 'myledgernoorview', permission: '/root/noor/promo/list' },
                { text: 'Special Trade', iconCls: 'x-fa fa-phone', leaf: true, viewType: 'myspotorderspecialnoorview', permission: '/root/noor/sale' },
                {
                    text: 'Storage Fee', iconCls: 'x-fa fa-coins', selectable: false,
                    children: [
                ...
                // { text: 'Gold Transaction', iconCls: 'x-fa fa-truck', leaf: true, viewType: 'mygoldtransactionview', permission: '/root/bmmb/goldtransaction/list' },
                // { text: 'Documentation', iconCls: 'x-fa fa-file-contract', leaf: true, viewType: 'godocumentationview', permission: '/root/noor/documentation/list' },               
                { text: 'Report', iconCls: 'x-fa fa-chart-bar', selectable: false,
                    children:[
                        { text: 'Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'mynoorcommissionview', permission: '/root/noor/report/commission/list' },
                        { text: 'Non-Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'mynoorcommissionnonpeakview', permission: '/root/noor/report/commission/list' },
                        { text: 'Daily Admin & Storage Fee', iconCls: 'x-fa fa-calendar-day', leaf: true, viewType: 'mynoordailystoragefeeview', permission: '/root/noor/report/storagefee/list' },
                        { text: 'Monthly Admin & Storage Fee', iconCls: 'x-fa fa-calendar-alt', leaf: true, viewType: 'mynoormonthlystoragefeeview', permission: '/root/noor/report/storagefee/list' },
                        { text: 'Monthly Summary', iconCls: 'x-fa fa-user', leaf: true, viewType: 'mynoormonthlysummaryview', permission: '/root/noor/report/monthlysummary/list' },
                    ]
                },
            ]
        },
        ...
        // WAQAF
        { text: 'ANNURGOLD', iconCls: 'x-fa fa-university', selectable: false,
            children: [
                { text: 'Spot Orders', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'waqaforderview', permission: '/root/waqaf/goldtransaction/list' },
                { text: 'Price Alert', iconCls: 'x-fa fa-clock', leaf: true, viewType: 'waqafpricealertview', permission: '/root/waqaf/pricealert/list' },
                { text: 'Conversion', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'waqafconversionview', permission: '/root/waqaf/redemption/list' },
                { text: 'Logistic', iconCls: 'x-fa fa-truck', leaf: true, viewType: 'waqaflogisticview', permission: '/root/waqaf/logistic/list' },
                { text: 'Account Holder', iconCls: 'x-fa fa-id-card', leaf: true, viewType: 'myaccountholderwaqafview', permission: '/root/waqaf/profile/list' },
                { text: 'Account Closure', iconCls: 'x-fa fa-eraser', leaf: true, viewType: 'mywaqafaccountclosureview', permission: '/root/waqaf/accountclosure/list' },
                { text: 'User Profile', iconCls: 'x-fa fa-id-card', visible: false, leaf: true, viewType: 'mywaqafcifview', permission: '/root/waqaf/profile/list', },
                { text: 'Gold Transfer', iconCls: 'x-fa fa-arrows-alt-h', leaf: true, viewType: 'mytransfergoldwaqafview', permission: '/root/waqaf/transfergold/list' },
                { text: 'Promo', iconCls: 'x-fa fa-rocket', leaf: true, viewType: 'myledgerwaqafview', permission: '/root/waqaf/promo/list' },
                { text: 'Special Trade', iconCls: 'x-fa fa-phone', leaf: true, viewType: 'myspotorderspecialwaqafview', permission: '/root/waqaf/sale' },
                {
                    text: 'Storage Fee', iconCls: 'x-fa fa-coins', selectable: false,
                    children: [
                ...
                { text: 'Report', iconCls: 'x-fa fa-chart-bar', selectable: false,
                    children:[
                        { text: 'Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'mywaqafcommissionview', permission: '/root/waqaf/report/commission/list' },
                        { text: 'Non-Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'mywaqafcommissionnonpeakview', permission: '/root/waqaf/report/commission/list' },
                        { text: 'Daily Admin & Storage Fee', iconCls: 'x-fa fa-calendar-day', leaf: true, viewType: 'mywaqafdailystoragefeeview', permission: '/root/waqaf/report/storagefee/list' },
                        { text: 'Monthly Admin & Storage Fee', iconCls: 'x-fa fa-calendar-alt', leaf: true, viewType: 'mywaqafmonthlystoragefeeview', permission: '/root/waqaf/report/storagefee/list' },
                        { text: 'Monthly Summary', iconCls: 'x-fa fa-user', leaf: true, viewType: 'mywaqafmonthlysummaryview', permission: '/root/waqaf/report/monthlysummary/list' },
                    ]
                },
            ]
        },
        // KASIH
        { text: 'KASIHGOLD', iconCls: 'x-fa fa-university', selectable: false,
            children: [
                { text: 'Spot Orders', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'kasihorderview', permission: '/root/kasih/goldtransaction/list' },
                { text: 'Price Alert', iconCls: 'x-fa fa-clock', leaf: true, viewType: 'kasihpricealertview', permission: '/root/kasih/pricealert/list' },
                { text: 'Conversion', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'kasihconversionview', permission: '/root/kasih/redemption/list' },
                { text: 'Logistic', iconCls: 'x-fa fa-truck', leaf: true, viewType: 'kasihlogisticview', permission: '/root/kasih/logistic/list' },
                { text: 'Account Holder', iconCls: 'x-fa fa-id-card', leaf: true, viewType: 'myaccountholderkasihview', permission: '/root/kasih/profile/list' },
                { text: 'Account Closure', iconCls: 'x-fa fa-eraser', leaf: true, viewType: 'mykasihaccountclosureview', permission: '/root/kasih/accountclosure/list' },
                { text: 'User Profile', iconCls: 'x-fa fa-id-card', visible: false, leaf: true, viewType: 'mykasihcifview', permission: '/root/kasih/profile/list', },
                { text: 'Gold Transfer', iconCls: 'x-fa fa-arrows-alt-h', leaf: true, viewType: 'mytransfergoldkasihview', permission: '/root/kasih/transfergold/list' },
                { text: 'Promo', iconCls: 'x-fa fa-rocket', leaf: true, viewType: 'myledgerkasihview', permission: '/root/kasih/promo/list' },
                { text: 'Special Trade', iconCls: 'x-fa fa-phone', leaf: true, viewType: 'myspotorderspecialkasihview', permission: '/root/kasih/sale' },
                {
                    text: 'Storage Fee', iconCls: 'x-fa fa-coins', selectable: false,
                    children: [
                ...
                { text: 'Report', iconCls: 'x-fa fa-chart-bar', selectable: false,
                    children:[
                        { text: 'Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'mykasihcommissionview', permission: '/root/kasih/report/commission/list' },
                        { text: 'Non-Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'mykasihcommissionnonpeakview', permission: '/root/kasih/report/commission/list' },
                        { text: 'Daily Admin & Storage Fee', iconCls: 'x-fa fa-calendar-day', leaf: true, viewType: 'mykasihdailystoragefeeview', permission: '/root/kasih/report/storagefee/list' },
                        { text: 'Monthly Admin & Storage Fee', iconCls: 'x-fa fa-calendar-alt', leaf: true, viewType: 'mykasihmonthlystoragefeeview', permission: '/root/kasih/report/storagefee/list' },
                        { text: 'Monthly Summary', iconCls: 'x-fa fa-user', leaf: true, viewType: 'mykasihmonthlysummaryview', permission: '/root/kasih/report/monthlysummary/list' },
                    ]
                },
            ]
        },
        // POSARRAHNU
        { text: 'POSARRAHNUGOLD', iconCls: 'x-fa fa-university', selectable: false,
                children: [
                    { text: 'Spot Orders', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'posarrahnuorderview', permission: '/root/posarrahnu/goldtransaction/list' },
                    { text: 'Price Alert', iconCls: 'x-fa fa-clock', leaf: true, viewType: 'posarrahnupricealertview', permission: '/root/posarrahnu/pricealert/list' },
                    { text: 'Conversion', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'posarrahnuconversionview', permission: '/root/posarrahnu/redemption/list' },
                    { text: 'Logistic', iconCls: 'x-fa fa-truck', leaf: true, viewType: 'posarrahnulogisticview', permission: '/root/posarrahnu/logistic/list' },
                    { text: 'Account Holder', iconCls: 'x-fa fa-id-card', leaf: true, viewType: 'myaccountholderposarrahnuview', permission: '/root/posarrahnu/profile/list' },
                    { text: 'Account Closure', iconCls: 'x-fa fa-eraser', leaf: true, viewType: 'myposarrahnuaccountclosureview', permission: '/root/posarrahnu/accountclosure/list' },
                    { text: 'User Profile', iconCls: 'x-fa fa-id-card', visible: false, leaf: true, viewType: 'myposarrahnucifview', permission: '/root/posarrahnu/profile/list', },
                    { text: 'Gold Transfer', iconCls: 'x-fa fa-arrows-alt-h', leaf: true, viewType: 'mytransfergoldposarrahnuview', permission: '/root/posarrahnu/transfergold/list' },
                    { text: 'Promo', iconCls: 'x-fa fa-rocket', leaf: true, viewType: 'myledgerposarrahnuview', permission: '/root/posarrahnu/promo/list' },
                    { text: 'Special Trade', iconCls: 'x-fa fa-phone', leaf: true, viewType: 'myspotorderspecialposarrahnuview', permission: '/root/posarrahnu/sale' },
                    {
                        text: 'Storage Fee', iconCls: 'x-fa fa-coins', selectable: false,
                        children: [
                    ...
                    { text: 'Report', iconCls: 'x-fa fa-chart-bar', selectable: false,
                        children:[
                            { text: 'Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'myposarrahnucommissionview', permission: '/root/posarrahnu/report/commission/list' },
                            { text: 'Non-Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'myposarrahnucommissionnonpeakview', permission: '/root/posarrahnu/report/commission/list' },
                            { text: 'Daily Admin & Storage Fee', iconCls: 'x-fa fa-calendar-day', leaf: true, viewType: 'myposarrahnudailystoragefeeview', permission: '/root/posarrahnu/report/storagefee/list' },
                            { text: 'Monthly Admin & Storage Fee', iconCls: 'x-fa fa-calendar-alt', leaf: true, viewType: 'myposarrahnumonthlystoragefeeview', permission: '/root/posarrahnu/report/storagefee/list' },
                            { text: 'Monthly Summary', iconCls: 'x-fa fa-user', leaf: true, viewType: 'myposarrahnumonthlysummaryview', permission: '/root/posarrahnu/report/monthlysummary/list' },
                        ]
                    },
                ]
            },
            { text: 'IGOLD', iconCls: 'x-fa fa-university', selectable: false,
            children: [
                { text: 'Spot Orders', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'igoldorderview', permission: '/root/igold/goldtransaction/list' },
                { text: 'Price Alert', iconCls: 'x-fa fa-clock', leaf: true, viewType: 'igoldpricealertview', permission: '/root/igold/pricealert/list' },
                { text: 'Conversion', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'igoldconversionview', permission: '/root/igold/redemption/list' },
                { text: 'Logistic', iconCls: 'x-fa fa-truck', leaf: true, viewType: 'igoldlogisticview', permission: '/root/igold/logistic/list' },
                { text: 'Account Holder', iconCls: 'x-fa fa-id-card', leaf: true, viewType: 'myaccountholderigoldview', permission: '/root/igold/profile/list' },
                { text: 'Account Closure', iconCls: 'x-fa fa-eraser', leaf: true, viewType: 'myigoldaccountclosureview', permission: '/root/igold/accountclosure/list' },
                { text: 'User Profile', iconCls: 'x-fa fa-id-card', visible: false, leaf: true, viewType: 'myigoldcifview', permission: '/root/igold/profile/list', },
                { text: 'Gold Transfer', iconCls: 'x-fa fa-arrows-alt-h', leaf: true, viewType: 'mytransfergoldigoldview', permission: '/root/igold/transfergold/list' },
                { text: 'Promo', iconCls: 'x-fa fa-rocket', leaf: true, viewType: 'myledgerigoldview', permission: '/root/igold/promo/list' },
                { text: 'Special Trade', iconCls: 'x-fa fa-phone', leaf: true, viewType: 'myspotorderspecialigoldview', permission: '/root/igold/sale' },
                {
                    text: 'Storage Fee', iconCls: 'x-fa fa-coins', selectable: false,
                    children: [
                ...
                { text: 'Report', iconCls: 'x-fa fa-chart-bar', selectable: false,
                    children:[
                        { text: 'Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'myigoldcommissionview', permission: '/root/igold/report/commission/list' },
                        { text: 'Non-Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'myigoldcommissionnonpeakview', permission: '/root/igold/report/commission/list' },
                        { text: 'Daily Admin & Storage Fee', iconCls: 'x-fa fa-calendar-day', leaf: true, viewType: 'myigolddailystoragefeeview', permission: '/root/igold/report/storagefee/list' },
                        { text: 'Monthly Admin & Storage Fee', iconCls: 'x-fa fa-calendar-alt', leaf: true, viewType: 'myigoldmonthlystoragefeeview', permission: '/root/igold/report/storagefee/list' },
                        { text: 'Monthly Summary', iconCls: 'x-fa fa-user', leaf: true, viewType: 'myigoldmonthlysummaryview', permission: '/root/igold/report/monthlysummary/list' },
                    ]
                },
            ]
        },
        { text: 'BURSAGOLD', iconCls: 'x-fa fa-university', selectable: false,
            children: [
                { text: 'Spot Orders', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'bursaorderview', permission: '/root/bursa/order/list' },
                { text: 'Price Alert', iconCls: 'x-fa fa-clock', leaf: true, viewType: 'bursapricealertview', permission: '/root/bursa/pricealert/list' },
                { text: 'Redemption', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'bursaconversionview', permission: '/root/bursa/redemption/list' },
                { text: 'Logistic', iconCls: 'x-fa fa-truck', leaf: true, viewType: 'bursalogisticview', permission: '/root/bursa/logistic/list' },
                { text: 'Account Holder', iconCls: 'x-fa fa-id-card', leaf: true, viewType: 'myaccountholderbursaview', permission: '/root/bursa/profile/list' },
                { text: 'Account Closure', iconCls: 'x-fa fa-eraser', leaf: true, viewType: 'mybursaaccountclosureview', permission: '/root/bursa/accountclosure/list' },
                { text: 'User Profile', iconCls: 'x-fa fa-id-card', visible: false, leaf: true, viewType: 'mybursacifview', permission: '/root/bursa/profile/list', },
                { text: 'Gold Transfer', iconCls: 'x-fa fa-arrows-alt-h', leaf: true, viewType: 'mytransfergoldbursaview', permission: '/root/bursa/transfergold/list' },
                { text: 'Promo', iconCls: 'x-fa fa-rocket', leaf: true, viewType: 'myledgerbursaview', permission: '/root/bursa/promo/list' },
                { text: 'Special Trade', iconCls: 'x-fa fa-phone', leaf: true, viewType: 'myspotorderspecialbursaview', permission: '/root/bursa/sale' },
                { text: 'Vault', iconCls: 'x-fa fa-warehouse', leaf: true, viewType: 'bursavaultitem-border-new', permission: '/root/bursa/vault/list'},
                { text: 'Minted Vault', iconCls: 'x-fa fa-bars', leaf: true, viewType: 'mintedbarstatusbursaview', permission: '/root/bursa/mintedbar/list' },
                ...
                { text: 'Report', iconCls: 'x-fa fa-chart-bar', selectable: false,
                    children:[
                        { text: 'Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'mybursacommissionview', permission: '/root/bursa/report/commission/list' },
                        { text: 'Non-Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'mybursacommissionnonpeakview', permission: '/root/bursa/report/commission/list' },
                        { text: 'Daily Admin & Storage Fee', iconCls: 'x-fa fa-calendar-day', leaf: true, viewType: 'mybursadailystoragefeeview', permission: '/root/bursa/report/storagefee/list' },
                        { text: 'Monthly Admin & Storage Fee', iconCls: 'x-fa fa-calendar-alt', leaf: true, viewType: 'mybursamonthlystoragefeeview', permission: '/root/bursa/report/storagefee/list' },
                        { text: 'Monthly Summary', iconCls: 'x-fa fa-user', leaf: true, viewType: 'mybursamonthlysummaryview', permission: '/root/bursa/report/monthlysummary/list' },
                    ]
                },
            ]
        },
        { text: 'BSNMyGold-i', iconCls: 'x-fa fa-university', selectable: false,
            children: [
                { text: 'Spot Orders', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'bsnorderview', permission: '/root/bsn/order/list' },
                { text: 'Price Alert', iconCls: 'x-fa fa-clock', leaf: true, viewType: 'bsnpricealertview', permission: '/root/bsn/pricealert/list' },
                { text: 'Redemption', iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'bsnconversionview', permission: '/root/bsn/redemption/list' },
                { text: 'Logistic', iconCls: 'x-fa fa-truck', leaf: true, viewType: 'bsnlogisticview', permission: '/root/bsn/logistic/list' },
                { text: 'Account Holder', iconCls: 'x-fa fa-id-card', leaf: true, viewType: 'myaccountholderbsnview', permission: '/root/bsn/profile/list' },
                { text: 'Account Closure', iconCls: 'x-fa fa-eraser', leaf: true, viewType: 'mybsnaccountclosureview', permission: '/root/bsn/accountclosure/list' },
                { text: 'User Profile', iconCls: 'x-fa fa-id-card', visible: false, leaf: true, viewType: 'mybsncifview', permission: '/root/bsn/profile/list', },
                { text: 'Gold Transfer', iconCls: 'x-fa fa-arrows-alt-h', leaf: true, viewType: 'mytransfergoldbsnview', permission: '/root/bsn/transfergold/list' },
                { text: 'Promo', iconCls: 'x-fa fa-rocket', leaf: true, viewType: 'myledgerbsnview', permission: '/root/bsn/promo/list' },
                { text: 'Special Trade', iconCls: 'x-fa fa-phone', leaf: true, viewType: 'myspotorderspecialbsnview', permission: '/root/bsn/sale' },
                { text: 'Vault', iconCls: 'x-fa fa-warehouse', leaf: true, viewType: 'mybsnvaultitem-border', permission: '/root/bsn/vault/list'},
               // { text: 'Minted Vault', iconCls: 'x-fa fa-bars', leaf: true, viewType: 'mintedbarstatusbsnview', permission: '/root/bsn/mintedbar/list' },
                ...
                { text: 'Report', iconCls: 'x-fa fa-chart-bar', selectable: false,
                    children:[
                        { text: 'Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'mybsncommissionview', permission: '/root/bsn/report/commission/list' },
                        { text: 'Non-Peak Commission', iconCls: 'x-fa fa-coins', leaf: true, viewType: 'mybsncommissionnonpeakview', permission: '/root/bsn/report/commission/list' },
                        { text: 'Daily Admin & Storage Fee', iconCls: 'x-fa fa-calendar-day', leaf: true, viewType: 'mybsndailystoragefeeview', permission: '/root/bsn/report/storagefee/list' },
                        { text: 'Monthly Admin & Storage Fee', iconCls: 'x-fa fa-calendar-alt', leaf: true, viewType: 'mybsnmonthlystoragefeeview', permission: '/root/bsn/report/storagefee/list' },
                        { text: 'Monthly Summary', iconCls: 'x-fa fa-user', leaf: true, viewType: 'mybsnmonthlysummaryview', permission: '/root/bsn/report/monthlysummary/list' },
                    ]
                },
            ]
        },

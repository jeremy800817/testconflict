Ext.define('snap.view.mintedbarstatus.MintedBarStatusBsn', {
    extend: 'Ext.container.Container',
    xtype: 'mintedbarstatusbsnview',
    requires: [
    ...
    permissionRoot: '/root/bsn/mintedbar',
    partnercode: 'BSN',
    layout: {
        type: 'vbox',
        align: 'center'
    ...
    listeners: {
        ...
        afterrender: function () {
            ...
            var panel = Ext.getCmp('bsn-mintedwarehouseinventory-display');
            var button = Ext.getCmp('bsn-minted-warehouse-download-button');
    ...
    items: [
...

        {
            ...
            items: [
                {
                    title: 'Minted Bar Inventory List By Denomination for Bsngold',
                    text: 'Download', 
                    tooltip: 'Export Data', 
                    header: {
                        style: 'background-color: #204A6D;border-color: #204A6D;',
                    ...
                    id: 'bsn-mintedwarehouseinventory-display',
                    layout: 'vbox',
                    width: '100%',
                    header: {
                        ...
                        items: [{
                            ...
                            id: 'bsn-minted-warehouse-download-button',
                            ...
                            listeners : {
                                ...
                                click: {
                                    ...
                                    fn: function(){ 
                                        ...
                                        Ext.getCmp('bsn-minted-warehouse-download-button').me.exportMintedListButton('GS-999-9');
                                    }
                                },
                            }
                        }]

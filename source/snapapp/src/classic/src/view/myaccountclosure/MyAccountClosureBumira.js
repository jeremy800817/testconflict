Ext.define('snap.view.myaccountclosure.MyAccountClosureBumira', {
    extend: 'snap.view.myaccountclosure.MyAccountClosure',
    xtype: 'mybumiraaccountclosureview',
    partnercode: 'BUMIRA',
    permissionRoot: '/root/bumira/accountclosure',
    store: {
        type: 'MyAccountClosure', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myaccountclosure&action=list&partnercode=BUMIRA',
            reader: {
                type: 'json',

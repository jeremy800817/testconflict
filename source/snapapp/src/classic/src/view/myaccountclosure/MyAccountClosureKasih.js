Ext.define('snap.view.myaccountclosure.MyAccountClosureKasih', {
    extend: 'snap.view.myaccountclosure.MyAccountClosure',
    xtype: 'mykasihaccountclosureview',
    partnercode: 'KASIH',
    permissionRoot: '/root/kasih/accountclosure',
    store: {
        type: 'MyAccountClosure', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myaccountclosure&action=list&partnercode=KASIH',
            reader: {
                type: 'json',

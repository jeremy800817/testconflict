Ext.define('snap.view.myaccountclosure.MyAccountClosurePkbAffi', {
    extend: 'snap.view.myaccountclosure.MyAccountClosure',
    xtype: 'mypkbaffiaccountclosureview',
    partnercode: 'PKBAFFI',
    permissionRoot: '/root/pkbaffi/accountclosure',
    store: {
        type: 'MyAccountClosure', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myaccountclosure&action=list&partnercode=PKBAFFI',
            reader: {
                type: 'json',

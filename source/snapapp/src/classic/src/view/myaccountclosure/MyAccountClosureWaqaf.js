Ext.define('snap.view.myaccountclosure.MyAccountClosureWaqaf', {
    extend: 'snap.view.myaccountclosure.MyAccountClosure',
    xtype: 'mywaqafaccountclosureview',
    partnercode: 'WAQAF',
    permissionRoot: '/root/waqaf/accountclosure',
    store: {
        type: 'MyAccountClosure', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myaccountclosure&action=list&partnercode=WAQAF',
            reader: {
                type: 'json',

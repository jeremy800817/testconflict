Ext.define('snap.view.myaccountholder.MyAccountHolderBsn', {
    extend: 'snap.view.myaccountholder.MyAccountHolder',
    xtype: 'myaccountholderbsnview',
    ...
    permissionRoot: '/root/bsn/profile',
    store: {
        type: 'MyAccountHolder',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myaccountholder&action=list&partnercode=BSN',
            reader: {
                type: 'json',

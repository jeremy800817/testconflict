...
Ext.define('snap.view.myaccountholder.MyAccountHolderBursa', {
    extend: 'snap.view.myaccountholder.MyAccountHolder',
    xtype: 'myaccountholderbursaview',
    ...
    permissionRoot: '/root/bursa/profile',
    store: {
        type: 'MyAccountHolder',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myaccountholder&action=list&partnercode=BURSA',
            reader: {
                type: 'json',

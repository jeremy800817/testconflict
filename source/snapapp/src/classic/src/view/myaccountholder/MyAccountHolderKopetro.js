Ext.define('snap.view.myaccountholder.MyAccountHolderKopetro', {
    extend: 'snap.view.myaccountholder.MyAccountHolderLoan',
    xtype: 'myaccountholderkopetroview',
    ...
    permissionRoot: '/root/kopetro/profile',
    store: {
        type: 'MyAccountHolder',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myaccountholder&action=list&partnercode=KOPETRO',
            reader: {
                type: 'json',

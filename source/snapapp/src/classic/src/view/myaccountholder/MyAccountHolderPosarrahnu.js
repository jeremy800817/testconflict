Ext.define('snap.view.myaccountholder.MyAccountHolderPosarrahnu', {
    extend: 'snap.view.myaccountholder.MyAccountHolder',
    xtype: 'myaccountholderposarrahnuview',
    ...
    permissionRoot: '/root/posarrahnu/profile',
    store: {
        type: 'MyAccountHolder',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myaccountholder&action=list&partnercode=POSARRAHNU',
            reader: {
                type: 'json',

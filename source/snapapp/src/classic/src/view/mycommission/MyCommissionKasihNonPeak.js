Ext.define('snap.view.mycommission.MyCommissionKasihNonPeak', {
    extend: 'snap.view.mycommission.MyCommissionKasih',
    xtype: 'mykasihcommissionnonpeakview',
    partnercode: 'KASIH',
    nonpeak: true,
    permissionRoot: '/root/kasih/report/commission',
    store: {
        type: 'MyCommission', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mycommission&action=list&partnercode=KASIH&nonpeak=true',
            reader: {
                type: 'json',

Ext.define('snap.view.mycommission.MyCommissionKoponasNonPeak', {
    extend: 'snap.view.mycommission.MyCommissionKoponas',
    xtype: 'mykoponascommissionnonpeakview',
    partnercode: 'KOPONAS',
    nonpeak: true,
    permissionRoot: '/root/koponas/report/commission',
    store: {
        type: 'MyCommission', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mycommission&action=list&partnercode=KOPONAS&nonpeak=true',
            reader: {
                type: 'json',

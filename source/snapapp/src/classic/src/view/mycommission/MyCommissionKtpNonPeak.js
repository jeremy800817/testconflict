Ext.define('snap.view.mycommission.MyCommissionKtpNonPeak', {
    extend: 'snap.view.mycommission.MyCommissionKtp',
    xtype: 'myktpcommissionnonpeakview',
    partnercode: 'KTP',
    nonpeak: true,
    ...
    store: {
        type: 'MyCommission', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mycommission&action=list&partnercode=KTP&nonpeak=true',
            reader: {
                type: 'json',

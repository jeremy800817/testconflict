Ext.define('snap.view.mycommission.MyCommissionWaqafNonPeak', {
    extend: 'snap.view.mycommission.MyCommissionWaqaf',
    xtype: 'mywaqafcommissionnonpeakview',
    partnercode: 'WAQAF',
    nonpeak: true,
    permissionRoot: '/root/waqaf/report/commission',
    store: {
        type: 'MyCommission', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mycommission&action=list&partnercode=WAQAF&nonpeak=true',
            reader: {
                type: 'json',

Ext.define('snap.view.mydailystoragefee.MyDailyStorageFeeKasih', {
    extend: 'snap.view.mydailystoragefee.MyDailyStorageFee',
    xtype: 'mykasihdailystoragefeeview',
    ...
    store: {
        type: 'MyDailyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mydailystoragefee&action=list&partnercode=KASIH',
            reader: {
                type: 'json',

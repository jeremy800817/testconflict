Ext.define('snap.view.mydailystoragefee.MyDailyStorageFeeKgoldAffi', {
    extend: 'snap.view.mydailystoragefee.MyDailyStorageFee',
    xtype: 'mykgoldaffidailystoragefeeview',
    ...
    store: {
        type: 'MyDailyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mydailystoragefee&action=list&partnercode=KGOLDAFFI',
            reader: {
                type: 'json',

Ext.define('snap.view.mydailystoragefee.MyDailyStorageFeeKodimas', {
    extend: 'snap.view.mydailystoragefee.MyDailyStorageFee',
    xtype: 'mykodimasdailystoragefeeview',
    ...
    store: {
        type: 'MyDailyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mydailystoragefee&action=list&partnercode=KODIMAS',
            reader: {
                type: 'json',

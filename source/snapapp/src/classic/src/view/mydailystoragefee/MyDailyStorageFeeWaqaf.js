Ext.define('snap.view.mydailystoragefee.MyDailyStorageFeeWaqaf', {
    extend: 'snap.view.mydailystoragefee.MyDailyStorageFee',
    xtype: 'mywaqafdailystoragefeeview',
    ...
    store: {
        type: 'MyDailyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mydailystoragefee&action=list&partnercode=WAQAF',
            reader: {
                type: 'json',

Ext.define('snap.view.myledger.MyLedgerKasih', {
    extend: 'snap.view.myledger.MyLedger',
    xtype: 'myledgerkasihview',
    ...
    permissionRoot: '/root/kasih/promo',
    store: {
        type: 'MyLedger',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myledger&action=list&partnercode=KASIH',
            reader: {
                type: 'json',

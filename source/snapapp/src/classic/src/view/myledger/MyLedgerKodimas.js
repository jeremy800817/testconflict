Ext.define('snap.view.myledger.MyLedgerKodimas', {
    extend: 'snap.view.myledger.MyLedger',
    xtype: 'myledgerkodimasview',
    ...
    permissionRoot: '/root/kodimas/promo',
    store: {
        type: 'MyLedger',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myledger&action=list&partnercode=KODIMAS',
            reader: {
                type: 'json',

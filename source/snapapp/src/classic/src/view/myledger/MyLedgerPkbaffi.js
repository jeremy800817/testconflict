Ext.define('snap.view.myledger.MyLedgerPkbaffi', {
    extend: 'snap.view.myledger.MyLedger',
    xtype: 'myledgerpkbaffiview',
    ...
    permissionRoot: '/root/pkbaffi/promo',
    store: {
        type: 'MyLedger',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myledger&action=list&partnercode=PKBAFFI',
            reader: {
                type: 'json',

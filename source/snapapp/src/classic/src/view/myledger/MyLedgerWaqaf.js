Ext.define('snap.view.myledger.MyLedgerWaqaf', {
    extend: 'snap.view.myledger.MyLedger',
    xtype: 'myledgerwaqafview',
    ...
    permissionRoot: '/root/waqaf/promo',
    store: {
        type: 'MyLedger',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myledger&action=list&partnercode=WAQAF',
            reader: {
                type: 'json',

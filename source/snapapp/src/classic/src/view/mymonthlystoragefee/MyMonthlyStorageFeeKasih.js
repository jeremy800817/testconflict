Ext.define('snap.view.mymonthlystoragefee.MyMonthlyStorageFeeKasih', {
    extend: 'snap.view.mymonthlystoragefee.MyMonthlyStorageFee',
    xtype: 'mykasihmonthlystoragefeeview',

    partnercode: 'KASIH',
    permissionRoot: '/root/kasih/report/storagefee',
    store: {
        type: 'MyMonthlyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlystoragefee&action=list&partnercode=KASIH',
            reader: {
                type: 'json',

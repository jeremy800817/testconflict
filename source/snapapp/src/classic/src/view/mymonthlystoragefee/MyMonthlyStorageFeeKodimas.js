Ext.define('snap.view.mymonthlystoragefee.MyMonthlyStorageFeeKodimas', {
    extend: 'snap.view.mymonthlystoragefee.MyMonthlyStorageFee',
    xtype: 'mykodimasmonthlystoragefeeview',

    partnercode: 'KODIMAS',
    permissionRoot: '/root/kodimas/report/storagefee',
    store: {
        type: 'MyMonthlyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlystoragefee&action=list&partnercode=KODIMAS',
            reader: {
                type: 'json',

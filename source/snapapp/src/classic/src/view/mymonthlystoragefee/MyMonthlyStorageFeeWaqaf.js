Ext.define('snap.view.mymonthlystoragefee.MyMonthlyStorageFeeWaqaf', {
    extend: 'snap.view.mymonthlystoragefee.MyMonthlyStorageFee',
    xtype: 'mywaqafmonthlystoragefeeview',

    partnercode: 'WAQAF',
    permissionRoot: '/root/waqaf/report/storagefee',
    store: {
        type: 'MyMonthlyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlystoragefee&action=list&partnercode=WAQAF',
            reader: {
                type: 'json',

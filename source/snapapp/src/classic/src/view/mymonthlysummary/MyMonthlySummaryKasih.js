Ext.define('snap.view.mymonthlysummary.MyMonthlySummaryKasih', {
    extend: 'snap.view.mymonthlysummary.MyMonthlySummary',
    xtype: 'mykasihmonthlysummaryview',
    partnercode: 'KASIH',
    store: {
        type: 'MyMonthlySummary', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlysummary&action=list&partnercode=KASIH',
            reader: {
                type: 'json',

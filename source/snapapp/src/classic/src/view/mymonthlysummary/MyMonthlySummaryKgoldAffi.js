Ext.define('snap.view.mymonthlysummary.MyMonthlySummaryKgoldAffi', {
    extend: 'snap.view.mymonthlysummary.MyMonthlySummary',
    xtype: 'mykgoldaffimonthlysummaryview',
    partnercode: 'KGOLDAFFI',
    store: {
        type: 'MyMonthlySummary', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlysummary&action=list&partnercode=KGOLDAFFI',
            reader: {
                type: 'json',

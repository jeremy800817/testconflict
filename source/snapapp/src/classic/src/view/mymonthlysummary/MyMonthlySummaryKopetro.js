Ext.define('snap.view.mymonthlysummary.MyMonthlySummaryKopetro', {
    extend: 'snap.view.mymonthlysummary.MyMonthlySummary',
    xtype: 'mykopetromonthlysummaryview',
    partnercode: 'KOPETRO',
    store: {
        type: 'MyMonthlySummary', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlysummary&action=list&partnercode=KOPETRO',
            reader: {
                type: 'json',
    ...
    toolbarItems: [
        ...
        { reference: 'printSummaryBtn', handler: 'getPrintReportKopetro', text: 'Print Summary', itemId: 'printSummaryBtn', tooltip: 'Print Summary', iconCls: 'x-fa fa-print', validSelection: 'ignore', showToolbarItemText: true },

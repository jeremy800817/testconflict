Ext.define('snap.view.mymonthlysummary.MyMonthlySummaryWaqaf', {
    extend: 'snap.view.mymonthlysummary.MyMonthlySummary',
    xtype: 'mywaqafmonthlysummaryview',
    partnercode: 'WAQAF',
    store: {
        type: 'MyMonthlySummary', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlysummary&action=list&partnercode=WAQAF',
            reader: {
                type: 'json',

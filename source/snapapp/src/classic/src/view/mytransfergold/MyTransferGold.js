Ext.define('snap.view.mytransfergold.MyTransferGold', {
    ...
    columns: [
        ...
        { text: 'Message', dataIndex: 'message', filter: { type: 'string' }, minWidth: 130, hidden: true },
        {
        ...
        // { text: 'Transfer By', dataIndex: 'createdbyname', filter: { type: 'string' }, hidden: true, minWidth: 130 },

Ext.define('snap.view.mytransfergold.MyTransferGoldKopttr', {
    extend: 'snap.view.mytransfergold.MyTransferGold',
    xtype: 'mytransfergoldkopttrview',
    ...
    permissionRoot: '/root/kopttr/transfergold',
    store: {
        type: 'MyTransferGold',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mytransfergold&action=list&partnercode=KOPTTR',
            reader: {
                type: 'json',

Ext.define('snap.view.mytransfergold.MyTransferGoldPkbaffi', {
    extend: 'snap.view.mytransfergold.MyTransferGold',
    xtype: 'mytransfergoldpkbaffiview',
    ...
    permissionRoot: '/root/pkbaffi/transfergold',
    store: {
        type: 'MyTransferGold',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mytransfergold&action=list&partnercode=PKBAFFI',
            reader: {
                type: 'json',

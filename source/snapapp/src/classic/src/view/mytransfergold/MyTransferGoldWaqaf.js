Ext.define('snap.view.mytransfergold.MyTransferGoldWaqaf', {
    extend: 'snap.view.mytransfergold.MyTransferGold',
    xtype: 'mytransfergoldwaqafview',
    ...
    permissionRoot: '/root/waqaf/transfergold',
    store: {
        type: 'MyTransferGold',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mytransfergold&action=list&partnercode=WAQAF',
            reader: {
                type: 'json',

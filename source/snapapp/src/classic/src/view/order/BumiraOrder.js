Ext.define('snap.view.order.BumiraOrder', {
    extend: 'snap.view.order.MyOrder',
    xtype: 'bumiraorderview',
    requires: [
    ...
    partnercode: 'BUMIRA',
    permissionRoot: '/root/bumira/goldtransaction',
    store: {
        type: 'MyOrder', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myorder&action=list&partnercode=BUMIRA',
            reader: {
                type: 'json',

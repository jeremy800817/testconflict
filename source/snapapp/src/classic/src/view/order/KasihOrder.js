Ext.define('snap.view.order.KasihOrder', {
    extend: 'snap.view.order.MyOrder',
    xtype: 'kasihorderview',
    requires: [
    ...
    partnercode: 'KASIH',
    permissionRoot: '/root/kasih/goldtransaction',
    store: {
        type: 'MyOrder', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myorder&action=list&partnercode=KASIH',
            reader: {
                type: 'json',

Ext.define('snap.view.order.KgoldAffiOrder', {
    extend: 'snap.view.order.MyOrder',
    xtype: 'kgoldaffiorderview',
    requires: [
    ...
    permissionRoot: '/root/kgoldaffi/goldtransaction',
    store: {
        type: 'MyOrder', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myorder&action=list&partnercode=KGOLDAFFI',
            reader: {
                type: 'json',

Ext.define('snap.view.order.KopetroOrder', {
    extend: 'snap.view.order.MyOrder',
    xtype: 'kopetroorderview',
    requires: [
    ...
    partnercode: 'KOPETRO',
    permissionRoot: '/root/kopetro/goldtransaction',
    store: {
        type: 'MyOrder', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myorder&action=list&partnercode=KOPETRO',
            reader: {
                type: 'json',

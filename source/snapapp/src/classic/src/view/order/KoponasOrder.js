Ext.define('snap.view.order.KoponasOrder', {
    extend: 'snap.view.order.MyOrder',
    xtype: 'koponasorderview',
    requires: [
    ...
    partnercode: 'KOPONAS',
    permissionRoot: '/root/koponas/goldtransaction',
    store: {
        type: 'MyOrder', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myorder&action=list&partnercode=KOPONAS',
            reader: {
                type: 'json',

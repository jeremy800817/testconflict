Ext.define('snap.view.order.KopttrOrder', {
    extend: 'snap.view.order.MyOrder',
    xtype: 'kopttrorderview',
    requires: [
    ...
    partnercode: 'KOPTTR',
    permissionRoot: '/root/kopttr/goldtransaction',
    store: {
        type: 'MyOrder', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myorder&action=list&partnercode=KOPTTR',
            reader: {
                type: 'json',

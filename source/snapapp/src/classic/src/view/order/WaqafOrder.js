Ext.define('snap.view.order.WaqafOrder', {
    extend: 'snap.view.order.MyOrder',
    xtype: 'waqaforderview',
    requires: [
    ...
    partnercode: 'WAQAF',
    permissionRoot: '/root/waqaf/goldtransaction',
    store: {
        type: 'MyOrder', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myorder&action=list&partnercode=WAQAF',
            reader: {
                type: 'json',

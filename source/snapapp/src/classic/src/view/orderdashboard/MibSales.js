Ext.define('snap.view.orderdashboard.MibSales',{
    ...
    requires: [
        ...
        'snap.view.orderdashboard.MibSalesDashboardController',

    ],
    viewModel: {
        data: {
            name: "Spot Order Special Mib",
            fees: [],
            permissions : [],
            dailylimit: [],
            products: [],
    ...
    store: 'mibsalesPriceStream',	
    controller: 'mibsalesdashboard-mibsalesdashboard',
    formDialogWidth: 950,
    ...
    initComponent: function(formView, form, record, asyncLoadCallback){
        ...
        Ext.create('snap.store.MibSalesPriceStream');
            ...
            function(data) {
                if (data.success) {
                    ...
                    if(data.status == 'offline'){
                        ...
                        Ext.getCmp('mibspotorderspecialpricestatus').setValue('<span style="color:#ffffff;font: 900 16px/22px Open Sans, Helvetica Neue, helvetica, arial, verdana, sans-serif;background-color:#C0282E;border-radius:40px;padding: 0.5em;">Offline</span>')
                    }else if(data.status == 'online'){
                        Ext.getCmp('mibspotorderspecialpricestatus').setValue('<span style="color:#ffffff;font: 900 16px/22px Open Sans, Helvetica Neue, helvetica, arial, verdana, sans-serif;background-color:#7ED321;border-radius:40px;padding: 0.5em;">Online</span>');
                    }else{
                        Ext.getCmp('mibspotorderspecialpricestatus').setValue('<span style="color:#ffffff;font: 900 16px/22px Open Sans, Helvetica Neue, helvetica, arial, verdana, sans-serif;background-color:#C0282E;border-radius:40px;padding: 0.5em;">No Response</span>')
                    }
                    
                    if (data.customers){
                        Ext.getCmp('mibcustomerspecial').getStore().loadData(data.customers);
                    }
        ...
        items: [
            {
                ...
                items: [{
                    ...
                    items: [{
                      html: '<h1>Spot Order Special For MIB</h1>',
                      flex: 10,
                      margin: '20 10',
                      //xtype: 'orderview',
                     //reference: 'spotorder',
            ...
            },
            {
                ...
                items: [{
                    ...
                    id: 'orderdashboardspotorderspecialmibform',
                    scrollable: false,
                    layout: 'hbox',
                    defaults: {
                        bodyPadding: '5',
                    ...
                    items:[
                        { xtype: 'container',
                            ...
                            items: [
                                {
                                    xtype: 'hiddenfield', id: 'mibsaleacesellprice', name:'saleacesellprice', reference: 'saleacesellprice', fieldLabel: 'Ace Sell Price', flex: 1, style:'padding-left: 20px;padding-right: 20px;', fieldStyle:" background-color: #ffffff ",
                                },
                                {
                                    xtype: 'hiddenfield', id: 'mibsaleacebuyprice', name:'saleacebuyprice', reference: 'saleacebuyprice', fieldLabel: 'Ace Buy Price', flex: 1, style:'padding-left: 20px;padding-right: 20px;', fieldStyle:" background-color: #ffffff ",
                                },
                                {
                                    xtype: 'hiddenfield', id: 'mibsaleorderuuid', name:'uuid', reference: 'uuid', fieldLabel: 'UUID', flex: 1, style:'padding-left: 20px;padding-right: 20px;', fieldStyle:" background-color: #ffffff ",
                                },
                                {
                                    xtype: 'hiddenfield', id: 'mibsaleacesellpricechange', name:'acesellpricechange', reference: 'acesellpricechange', fieldLabel: 'acesellpricechange', flex: 1, style:'padding-left: 20px;padding-right: 20px;', fieldStyle:" background-color: #ffffff ",
                                },
                                {
                                    xtype: 'hiddenfield', id: 'mibsaleacebuypricechange', name:'acebuypricechange', reference: 'acebuypricechange', fieldLabel: 'acebuypricechange', flex: 1, style:'padding-left: 20px;padding-right: 20px;', fieldStyle:" background-color: #ffffff ",
                                },
                                { xtype: 'combobox', flex: 1,fieldLabel:'Customer', id: 'mibcustomerspecial', style: 'margin-top:5%;', store: {type: 'array', fields: ['id', 'name']}, queryMode: 'local', remoteFilter: false, name: 'customer', valueField: 'id', displayField: 'name', reference: 'customer', forceSelection: false, editable: true,
                                ...
                                listeners: {
                                    ...
                                    if(productlist){
                                      ...
                                      // Load products
                                      Ext.getCmp('mibproductspecial').getStore().loadData(customerproducts);
                                ...
                                { xtype: 'combobox', flex:1, id: 'productspotspecial', fieldLabel:'Product', id: 'mibproductspecial', style: 'margin-top:5%;', store: {type: 'array', fields: ['id', 'name']}, queryMode: 'local', remoteFilter: false, name: 'product', valueField: 'id', displayField: 'name', reference: 'product', forceSelection: false, editable: true,
                                labelStyle: 'font: 900 13px/22px Open Sans, Helvetica Neue, helvetica, arial, verdana, sans-serif',
                                tpl: [
                                    '<ul class="x-list-plain">',
                                    '<tpl for=".">',
                                ...
                                { xtype: 'textfield', flex: 1,fieldLabel: 'Reference No.', id: 'mibspotspecialreferenceno', name: 'referenceno', labelStyle: 'font: 900 13px/22px Open Sans, Helvetica Neue, helvetica, arial, verdana, sans-serif', 
                                },
                                { xtype: 'textfield', flex: 1,fieldLabel: 'Total Value (RM)', id: 'mibtotalvaluespotspecial', name: 'totalvalue', labelStyle: 'font: 900 13px/22px Open Sans, Helvetica Neue, helvetica, arial, verdana, sans-serif', 
                                maskRe: /[0-9.-]/,
                                ...
                                listeners: {
                                    change: function( fld, newValue, oldValue, opts ) {
                                        Ext.getCmp('mibtotalxauweightspotspecial').disable();
                                        
                                        if(newValue == ''){
                                            Ext.getCmp('mibtotalxauweightspotspecial').enable();
                                        }
                                    }                    
                                }},
                                {
                                ...
                                { xtype: 'textfield', flex: 1, fieldLabel: 'Total XAU Weight (gram)', id: 'mibtotalxauweightspotspecial', name: 'totalxauweight', labelStyle: 'font: 900 13px/22px Open Sans, Helvetica Neue, helvetica, arial, verdana, sans-serif', 
                                maskRe: /[0-9.-]/,
                                validator: function(v) {
                                    return /^-?[0-9]*(\.[0-9]{1,2})?$/.test(v)? true : 'Only positive/negative float (x.yy)/int formats allowed!';
                                },
                                listeners: {
                                    change: function( fld, newValue, oldValue, opts ) {
                                        Ext.getCmp('mibtotalvaluespotspecial').disable();
                                        
                                        if(newValue == ''){
                                            Ext.getCmp('mibtotalvaluespotspecial').enable();
                                        }
                                    }                    
                                }},
                            ]

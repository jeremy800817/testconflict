Ext.define('snap.view.orderdashboard.MibSalesDashboardController', {
    extend: 'snap.view.gridpanel.BaseController',
    alias: 'controller.mibsalesdashboard-mibsalesdashboard',
    ...
    doSpotOrderSpecialSell: function(elemnt) {
        ...
        productspotvalue = Ext.getCmp('mibproductspecial');
       ...
       /*--------------------------------------------- Check Backend if requirements are met ----------------------------------------*/
        ...
        acebuyprice = parseFloat(Ext.getCmp('mibsaleacebuyprice').getRawValue()).toFixed(3);
        //If negative value
                            ...
                            if (spotpanelbuytotalvalue.getForm().isValid()) {
                                ...
                                snap.getApplication().sendRequest({
                                    hdl: 'order', action: 'doSpotOrderSpecial', 
                                        buyprice: Ext.getCmp('mibsaleacebuyprice').getRawValue(), 
                                        uuid: Ext.getCmp('mibsaleorderuuid').getRawValue(),
                                        amount: spotorder.totalvalue,
                                        productitem: spotorder.product,
                                        sellorbuy: 'buy',
                                        customerid: Ext.getCmp('mibcustomerspecial').getValue(),
                                ...
                                function(data){
                                    if(data.success){
                                        ...
                                        // Clear input form
                                        Ext.getCmp('orderdashboardspotorderspecialmibform').reset();
                ...
                */
                ...
                for (index = 0; index <forminput.length; index++ ){
                    ...
                    if(forminput[index].value != ""){
                        ...
                        // Check id
                        if(forminput[index].id == 'mibtotalvaluespotspecial' || forminput[index].id == 'mibtotalxauweightspotspecial' || forminput[index].id == 'mibsaleacebuyprice'){
                            ...
                            if(forminput[index].id == 'mibtotalvaluespotspecial' && Ext.getCmp('mibtotalvaluespotspecial').disabled == false){
                            ...
                            if(forminput[index].id == 'mibtotalxauweightspotspecial' && Ext.getCmp('mibtotalxauweightspotspecial').disabled == false){
                            ...
                            if(forminput[index].id == 'mibsaleacebuyprice' && Ext.getCmp('mibsaleacebuyprice').disabled == false){
...
`       */
       ...
       // Get orderfees
        ...
        acesellprice = parseFloat(Ext.getCmp('mibsaleacesellprice').getRawValue()).toFixed(3);
            ...
            buttons: [{
                ...
                handler: function(btn) {
                    if (spotpanelselltotalvalue.getForm().isValid()) {
                        ...
                        snap.getApplication().sendRequest({ 
                            hdl: 'order', action: 'doSpotOrderSpecial', 
                                sellprice: Ext.getCmp('mibsaleacesellprice').getRawValue(), 
                                uuid: Ext.getCmp('mibsaleorderuuid').getRawValue(),
                                amount: spotorder.totalvalue,
                                productitem: spotorder.product,
                                sellorbuy: 'sell',
                ...
                */
                ...
                for (index = 0; index <forminput.length; index++ ){
                    ...
                    if(forminput[index].value != ""){
                        ...
                        // If the filled fields are the 4 inputs
                        // Check id
                        if(forminput[index].id == 'mibtotalvaluespotspecial' || forminput[index].id == 'mibtotalxauweightspotspecial' || forminput[index].id == 'mibsaleacesellprice'){
                            ...
                            if(forminput[index].id == 'mibsaleacesellprice' && Ext.getCmp('mibsaleacesellprice').disabled == false){

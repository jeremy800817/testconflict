...
Ext.define('snap.view.redemption.MyConversionRequests', {
    ...
    columns: [
        ...
        { text: 'Customer NRIC', dataIndex: 'accountholdermykadno', renderer: 'setTextColor',filter: { type: 'string' } },
        { text: 'Customer Email', dataIndex: 'accountholderemail', renderer: 'setTextColor',filter: { type: 'string' } },
        { text: 'Customer Phone', dataIndex: 'accountholderphoneno', renderer: 'setTextColor',filter: { type: 'string' } },

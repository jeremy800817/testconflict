...
Ext.define('snap.view.redemption.MyConversionRequestsKtp', {
    extend: 'snap.view.redemption.RedemptionRequests',
    xtype: 'myconversionrequestsktp',
    requires: [
    ...
    toolbarItems: [
        ...
        {
            text: 'Download',tooltip: 'Print Daily Conversion Report',iconCls: 'x-fa fa-print', reference: 'dailyconversionreport', handler: 'getConversionReportKtp',  showToolbarItemText: true, printType: 'xlsx', // printType: pending
        },
        {

Ext.define('snap.view.redemption.RedemptionController', {
    ...
    setTextColor: function(val,m,record) {      
        ...
        if(record.get('status')==6) return '<span style="color:#000000;">' + val + '</span>';
    ...
    setStatusDesc: function(value,store) {
        if(value==0) return 'Pending';
            ...
            if(value==6) return 'Reversed';
            if(value==7) return 'Failed Delivery';
    ...
    getPrintReport: function(btn){
        ...
        url = '?hdl=redemption&action=exportExcel&header='+header+'&daterange='+daterange+'&partnercode='+partnercode;

Ext.define('snap.view.replenishment.ReplenishmentTreeController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.gridpanel-replenishmenttreecontroller',
    ...
    onRequestWindowSaveButton: (elemnt) => {
        ...
        date = elemnt.lookupReferenceHolder('collectiontab').getView().getController().lookupReference('deliverydate').value
        senderid = elemnt.lookupReferenceHolder('collectiontab').getView().getController().lookupReference('senderid').value
        snap.getApplication().sendRequest({
            ...
            .then(
                ...
                function(data){
                    if(data.success){
                        Ext.MessageBox.show({
                            title: 'Create Replenishment Logistic',
                            msg: 'Successful',

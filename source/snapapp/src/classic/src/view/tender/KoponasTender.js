Ext.define('snap.view.tender.KoponasTender',{
    extend: 'Ext.panel.Panel',
    xtype: 'koponastenderview',
    ...
    permissionRoot: '/root/koponas/tender',
    layout: 'fit',
    width: 500,
    height: 400,
        ...
        items: [
            {
              ...
              style: {
                ...
                items: [{
                    ...
                    items: [{
                      html: '<h1>Koponas Tender Upload</h1>',
                      flex: 10,

Ext.define('snap.view.tender.SahabatTender',{
    extend: 'Ext.panel.Panel',
    xtype: 'sahabattenderview',
    ...
    permissionRoot: '/root/sahabat/tender',
    layout: 'fit',
    width: 500,
    height: 400,
        ...
        items: [
            {
              ...
              style: {
                ...
                items: [{
                    ...
                    items: [{
                      html: '<h1>Sahabat Tender Upload</h1>',
                      flex: 10,

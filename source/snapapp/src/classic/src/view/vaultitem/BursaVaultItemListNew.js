Ext.define('snap.view.vaultitem.BursaVaulItemListNew', {
    ...
    store: {
        ...
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mibvaultitem&action=list&partnercode=BURSA',
            reader: {
                type: 'json',
    ...
    permissionRoot: '/root/bursa/vault',
    enableFilter: true,
    toolbarItems: [
        'detail', 'filter', '|',
        {
        ...
        {
            text: 'Return To HQ',
            tooltip: 'Return kilobar from BURSA to HQ',
    ...
    checkActionPermission: function (view, record) {
        ...
        var transferPermission = snap.getApplication().hasPermission('/root/bursa/vault/transfer');
        var returnPermission = snap.getApplication().hasPermission('/root/bursa/vault/return');

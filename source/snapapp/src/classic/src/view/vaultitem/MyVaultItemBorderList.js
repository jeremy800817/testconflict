Ext.define('snap.view.vaultitem.MyVaultItemBorderList', {
    extend: 'snap.view.vaultitem.vaultitemBorderList',
    xtype: 'myvaultitem-border',
    requires: [
        ...
        afterrender: function () {
            ...
            panel.add(
                ...
                },
                {
                    ...
                    items: [
                        {
                            html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#ffb91b"><span style="color:#ffffff;font-size:1.5em;font-weight:900;width:100%;height:300px" id="'+vaultamount+'">-</span><div style="color:#ffffff;font-size:1.2em;">'+partnerCode+' Vault (g)</div></div>',
                            width: '100%',
                            height: '33%',
                            flex: 1,
                        },
                        {
                            html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#00529B"><span style="color:#ffffff;font-size:1.5em;font-weight:900;width:100%;height:300px" id="'+totalcustomerholding+'">-</span><div style="color:#ffffff;font-size:0.9em;">Total Customer Holding (g)</div></div>',
                            width: '100%',
                            height: '33%',
                            flex: 1,
                        },
                        {
                            html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#ffb91b"><span style="color:#ffffff;font-size:1.5em;font-weight:900;width:100%;height:300px" id="'+totalbalance+'">-</span><div style="color:#ffffff;font-size:1.2em;">Balance (g)</div></div>',
                            width: '100%',
                            height: '33%',
                            flex: 1,
                        },
            ...
            snap.getApplication().sendRequest({
                ...
                function (data) {
                    if (data.success) {
                        ...
                        Ext.get(vaultamount).dom.innerHTML = data.vaultAmount;
                        Ext.get(totalcustomerholding).dom.innerHTML = data.totalCustomerHolding;
                        Ext.get(totalbalance).dom.innerHTML = data.totalBalance;

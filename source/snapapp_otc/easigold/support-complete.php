...
<body class="gogold">
    ...
    <div id="html-faq-wrapper">
      ...
      <div id="faq-header" style="width:100%">
        <p style="font-weight:bold;text-align:center">Thanks for your feedback!</p>
        <img src="easigold/img/bg/support-done-page.png" alt="" class="desktop"> 
      </div>
      <div class="form-row submit">
					<div class="form-col">
						<input id="submitbt" type="submit" onclick="history.back()" class="btn" value="Back" />
					</div>

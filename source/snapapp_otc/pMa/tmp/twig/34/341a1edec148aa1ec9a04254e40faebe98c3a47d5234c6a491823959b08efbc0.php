...
";
    ...
    {
        return new Source("", "server/privileges/privileges_summary.twig", "/usr/local/nginx/html/gtp/source/snapapp/pMa/templates/server/privileges/privileges_summary.twig");
    }
}

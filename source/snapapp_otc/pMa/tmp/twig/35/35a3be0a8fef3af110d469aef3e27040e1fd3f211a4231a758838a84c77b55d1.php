...
";
    ...
    {
        return new Source("", "columns_definitions/column_definitions_form.twig", "/usr/local/nginx/html/gtp/source/snapapp_otc/pMa/templates/columns_definitions/column_definitions_form.twig");
    }
}

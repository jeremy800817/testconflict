...
";
    ...
    {
        return new Source("", "server/privileges/global_priv_table.twig", "/usr/local/nginx/html/gtp/source/snapapp/pMa/templates/server/privileges/global_priv_table.twig");
    }
}

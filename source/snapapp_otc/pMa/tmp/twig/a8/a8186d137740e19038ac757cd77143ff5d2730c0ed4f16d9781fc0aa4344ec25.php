...
";
    ...
    {
        return new Source("", "server/privileges/require_options.twig", "/usr/local/nginx/html/gtp/source/snapapp_otc/pMa/templates/server/privileges/require_options.twig");
    }
}

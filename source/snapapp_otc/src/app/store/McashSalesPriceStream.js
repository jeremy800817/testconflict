...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&mcash=1&code=INTLX.MGOLD';
// var host_name = window.location.host;
// if (host_name.search('demo') >= 0 || host_name.search('uat') >= 0 ){
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&mcash=1&code=INTLX.MCASH';
// }else{
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&mcash=1&code=INTLX.MCASH';
// }
Ext.define('snap.store.McashSalesPriceStream', {
	...
	alias: 'store.McashSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'mcashsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'mcashsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('mcashsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('mcashsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('mcashsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('mcashspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('mcashspotsaleacesell').setValue(aceselldesign);

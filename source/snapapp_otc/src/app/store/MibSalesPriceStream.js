...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&mib=1';
Ext.define('snap.store.MibSalesPriceStream', {
	...
	alias: 'store.MibSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'mibsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'mibsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('mibsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('mibsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('mibsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('mibspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('mibspotsaleacesell').setValue(aceselldesign);

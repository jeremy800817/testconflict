...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&nubex=1&code=INTLX.NUSAGOLD';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&onecall=1&code=INTLX.ONECALL';
// }
Ext.define('snap.store.NubexSalesPriceStream', {
	...
	alias: 'store.NubexSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'nubexsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'nubexsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('nubexsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('nubexsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('nubexsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('nubexspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('nubexspotsaleacesell').setValue(aceselldesign);

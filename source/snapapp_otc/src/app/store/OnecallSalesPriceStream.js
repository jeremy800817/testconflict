...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&onecall=1&code=INTLX.ONECALL';
// }
Ext.define('snap.store.OnecallSalesPriceStream', {
	...
	alias: 'store.OnecallSalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'onecallsalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'onecallsalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('onecallsaleacesellprice').setValue(companysellppg);
					Ext.getCmp('onecallsaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('onecallsaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('onecallspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('onecallspotsaleacesell').setValue(aceselldesign);

...
var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&wavpay=1&code=INTLX.Wavpay';
...
//     var websocketurl = window.location.protocol == 'https:' ? 'wss://' : 'ws://'; websocketurl += window.location.hostname + '/streamprice?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&onecall=1&code=INTLX.ONECALL';
// }
Ext.define('snap.store.WavpaySalesPriceStream', {
	...
	alias: 'store.WavpaySalesPriceStream',
	model: 'snap.model.SalesPriceStream',
	storeId: 'wavpaysalesPriceStream',
	proxy: {
		type: 'websocket',
        storeId: 'wavpaysalesPriceStream',
			...
			transform: {
                ...
                */// Old color #404040
                ...
                // End of Ace Sell Price Confirmation
					...
					Ext.getCmp('wavpaysaleacesellprice').setValue(companysellppg);
					Ext.getCmp('wavpaysaleacebuyprice').setValue(companybuyppg);
                    Ext.getCmp('wavpaysaleorderuuid').setValue(data[0].uuid);
                    
                    prevbuyprice = companybuyppg;
                    prevsellprice = companysellppg;
                    
                    Ext.getCmp('wavpayspotsaleacebuy').setValue(acebuydesign);
                    Ext.getCmp('wavpayspotsaleacesell').setValue(aceselldesign);

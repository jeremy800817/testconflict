...
Ext.define('snap.view.analyticsdata.OTCAnalyticsData_ALRAJHI', {
    extend:'Ext.panel.Panel',
    xtype: 'otcanalyticsdataview_alrajhi',
    ...
    viewModel: {
        ...
        formulas: {
          ...
          formattedvault: function (get) {
            var vault = get('vault');
            return Ext.isNumber(vault) ? formatNumber(vault, 2) : '';
          },
          formattedtotalcustomerholding: function (get) {
            var totalcustomerholding = get('totalcustomerholding');
            return Ext.isNumber(totalcustomerholding) ? formatNumber(totalcustomerholding, 2) : '';
          },
          formattedbalance: function (get) {
            var balance = get('balance');
            return Ext.isNumber(balance) ? formatNumber(balance, 2) : '';
          }
        }
    },
        ...
        if (vm.get(channelName)) {
            ...
            if (fields.includes(key)) {
              if (vm.get(channelName)[key]) {
                ...
                let margincalcabove50k = (1 - ((vm.get('marginbelow50k') - vm.get('marginabove50k')) / 100 ) )
                let decreasedPrice = originalPrice * margincalcabove50k;
                let decreasedPriceDisplay = elmnt.formatPrice(decreasedPrice, formatDecimal);
                message.data[0][key + 'display1'] = decreasedPriceDisplay;
      
                // Decrease price by 0.75%
                let margincalcabove150k = (1 - ((vm.get('marginbelow50k') - vm.get('marginabove150k')) / 100 ) )
                let decreasedPrice2 = originalPrice * margincalcabove150k;
                let decreasedPriceDisplay2 = elmnt.formatPrice(decreasedPrice2, formatDecimal);
    ...
    initComponent: function(formView, form, record, asyncLoadCallback){
        ...
        const source = new EventSource('https://' + window.location.hostname + '/index.php?hdl=pssubscribe&action=subscribesales&pdt=DG-999-9&onecent=1&code=INTLX.ALRAJHI');
    ...
    items: {
        ...
        items: [,
            ...
            //                     var hastotalacchodlerpermission = snap.getApplication().hasPermission('/root/' + PROJECTBASE.toLowerCase() + '/analytics/totalaccholder');
            ...
            //             listeners: {
            //                 afterrender: function(form) {
            //                     var hastotalbuygoldpermission = snap.getApplication().hasPermission('/root/' + PROJECTBASE.toLowerCase() + '/analytics/totalbuygold');
            ...
            //             listeners: {
            //                 afterrender: function(form) {
            //                     var hastotalsellgoldpermission = snap.getApplication().hasPermission('/root/' + PROJECTBASE.toLowerCase() + '/analytics/totalsellgold');
            ...
            //             listeners: {
            //                 afterrender: function(form) {
            //                     var hasvaultpermission = snap.getApplication().hasPermission('/root/' + PROJECTBASE.toLowerCase() + '/analytics/vault');
            ...
            //             listeners: {
            //                 afterrender: function(form) {
            //                     var hastotalcustomerholdingpermission = snap.getApplication().hasPermission('/root/' + PROJECTBASE.toLowerCase() + '/analytics/totalcustomerholding');
            ...
            //                                 width: '100%',
            //                                 fieldCls: 'otc-displayfield-medium-text-dashboard-center',
            //                                 value: 'Total Customer Holding (g) <i class="fa fa-users"></i>',
            //                                 fieldStyle: 'text-align: center;',
            //                             },
            //                             {
            //                                 xtype: 'displayfield',
            ...
            //                                 value: '-',
            //                                 bind: {
            //                                     value: '{formattedtotalcustomerholding}'
            //                                 }
            //                             },
            //                         ],
            ...
            //             listeners: {
            //                 afterrender: function(form) {
            //                     var hasbalancepermission = snap.getApplication().hasPermission('/root/' + PROJECTBASE.toLowerCase() + '/analytics/balance');
            ...
            //                             width: '100%',
            //                             fieldCls: 'otc-displayfield-medium-text-dashboard-center',
            //                             value: 'Balance (g) <i class="fas fa-warehouse"></i>',
            //                             fieldStyle: 'text-align: center;',
            //                         },
            //                         {
            //                             xtype: 'displayfield',

    ...
    Ext.define('snap.view.home.AnnouncementSliderCarousel', {
        extend: 'Ext.DataView',
        ...
        buttons: false,
        puaseOnHover: false,
        emptyText: "<h5 style=' width:100%;text-align:center;line-height: 300%; overflow: inherit; margin:0px 0 30px; font-size: 16px;color:#757575;'><span style='background:#fff;padding:0 20px 0px 20px;position: relative;top: 10px;'>Welcome to Our site, there are no announcements at the moment</span></h5>",
        template: '',
        nextButtonText: 'next',

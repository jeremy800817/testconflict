...
Ext.define('snap.view.buyback.PosBuybackRequests', {
    extend: 'snap.view.gridpanel.Base',
    xtype: 'posbuybackrequests',
    requires: [
        'snap.store.PosBuyback',
        'snap.model.PosBuyback',
    ...
    toolbarItems: [
        ...
        {
            handlerModule: 'posbuyback', text: 'Download', tooltip: 'Export Data', iconCls: 'x-fa fa-download', handler: 'getPrintReport',  showToolbarItemText: true, printType: 'xlsx', // printType: pending
        }
    ],   
    columns: [

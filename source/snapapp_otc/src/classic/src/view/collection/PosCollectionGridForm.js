Ext.define('snap.view.collection.PosCollectionGridForm', {
    extend: 'snap.view.gridpanel.GridForm',
    alias: 'widget.PosCollectionGridForm',
    requires: [
        'Ext.panel.Panel',
        'Ext.window.Window',
        'Ext.form.*',
        'snap.view.gridpanel.BaseController',
        'snap.view.collection.PosCollectionTreeController',
    ...
    controller: 'gridpanel-poscollectiontreecontroller',

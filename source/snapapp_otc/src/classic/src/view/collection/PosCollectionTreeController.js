Ext.define('snap.view.collection.PosCollectionTreeController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.gridpanel-poscollectiontreecontroller',

    onPostLoadEmptyForm: function (formView, form) {
        this.onPreLoadForm(formView, form, Ext.create('snap.model.poscollection', { id: 0, }), null);
        this.onPreLoadForm(formView, form, Ext.create('snap.model.PosCollectionServices', { id: 0, }), null);
    },

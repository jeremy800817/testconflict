 ...
 **/
 Ext.define('snap.view.main.MainModel_ALRAJHI', {
    extend: 'Ext.app.ViewModel',

    alias: 'viewmodel.main_ALRAJHI',

    data: {
        applogo: '<div class="main-logo"><img src="src/resources/images/alrajhi_gold_logo_2.png" style="height:60px; margin-left:4px; top:2px;background: #1B4297"></div>',
        applogoNormal: '<div class="main-logo"><img src="src/resources/images/alrajhi_gold_logo_2.png" style="height:50px; margin-left:4px; top:2px;"></div>',
    ...
    menuItems: [
        // { text: getText('search'), iconCls: 'x-fa fa-search', leaf: true, viewType: 'orderdashboardview_'+PROJECTBASE, },
        // Old dashboard
        //{ text: getText('dashboard'), iconCls: 'x-fa fa-desktop', leaf: true, viewType: 'otcanalyticsdataview', permission: '/root/' + PROJECTBASE.toLowerCase() + '/analytics' },
        { text: 'Transaction', iconCls: 'x-fa fa-coins', selectable: false,
            children:[ 
                { text: getText('buy'), iconCls: 'x-fa fa-credit-card', leaf: true, viewType: 'searchbuyview', permission: '/root/' + PROJECTBASE.toLowerCase() + '/search/buy' },
                { text: getText('sell'), iconCls: 'x-fa fa-credit-card', leaf: true, viewType: 'searchsellview', permission: '/root/' + PROJECTBASE.toLowerCase() + '/search/sell' },
                { text: getText('redemption'), iconCls: 'x-fa fa-shopping-cart', leaf: true, viewType: 'searchconversionview', permission: '/root/'+ PROJECTBASE.toLowerCase() +'/search/redemption' },
            ]
        },
        { text: 'Inquiry', iconCls: 'x-fa fa-search', selectable: false,
            children:[
                { text: 'Profile', iconCls: 'x-fa fa-id-card', leaf: true, viewType: 'searchprofileview', permission: '/root/' + PROJECTBASE.toLowerCase() + '/search/profile' },
                { text: getText('transaction'), iconCls: 'x-fa fa-list', leaf: true, viewType: 'searchtransactionview', permission: '/root/' + PROJECTBASE.toLowerCase() + '/search/goldtransaction' },
            ]
        },
        {
            ...
            leaf: true,
            viewType: "otcanalyticsdataview_alrajhi",
        ...
        { text: getText('Transfer Gold'), iconCls: 'x-fa fa-random', leaf: true, viewType: 'MyTransferGoldForm_'+PROJECTBASE, permission: '/root/' + PROJECTBASE.toLowerCase() + '/transfergold' },
        { text: 'Report', iconCls: 'x-fa fa-file', selectable: false,
            children:[
                ...
                { 
                    ...
                    leaf: true, 
                    viewType: 'summary'+PROJECTBASE.toLowerCase(), 
                    permission: '/root/'+ PROJECTBASE.toLowerCase() +'/redemption/list' 
                },
                { text: getText("Transfer Gold"), iconCls: "x-fa fa-random", leaf: true, viewType: "mytransfergoldview_" + PROJECTBASE, permission: "/root/" + PROJECTBASE.toLowerCase() + "/transfergold/list" },
                { text: getText('Reconcil report'), iconCls: "x-fa fa-id-card", leaf: true, viewType: "myreconcilreportview_" + PROJECTBASE, permission: "/root/" + PROJECTBASE.toLowerCase() + "/transfergold/list" }
        ...
        { text: getText('pricemanagement'), iconCls: 'x-fa fa-book', selectable: false,
            children: [
                ...
                // { text: 'Price Validation', iconCls: 'x3-fa fa-user-check', leaf: true, viewType: 'PriceValidationView', permission: '/root/system/pricevalidation/list' },
        ...
        { text: 'Approvals', iconCls: 'x-fa fa-check', leaf: true, viewType: 'approvalview', permission: '/root/' + PROJECTBASE.toLowerCase() + '/goldtransaction/approval' },
        
        { text: getText('Upload Introducer/referrer'), iconCls: 'x-fa fa-upload', leaf: true, viewType: 'uploadIntroducerview', permission: '/root/' + PROJECTBASE.toLowerCase() + '/upload' },
  
        { text: 'System Settings', iconCls: 'x-fa fa-wrench', selectable: false,
            children: [
                { text: 'Branch',iconCls: 'x-fa fa-users',leaf: true, viewType: 'partnerview',  permission: '/root/system/partner/list' },

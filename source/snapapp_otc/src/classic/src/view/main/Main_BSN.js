...
Ext.define('snap.view.main.Main_BSN', {
    ...
    requires: [
        ...
        'snap.view.main.MainController_BSN',
        'snap.view.main.MainModel_BSN',
        'snap.view.main.MainContainerWrap_BSN',
        'snap.view.main.BlankPage_BSN',
...
*/              /*{
                ...
                },*/
                {
                    ...
                    bind: '{displayname}',                      
                    cls: 'top-user-name',
                    html: '11123 - AAINI ALJIAAH BINTI SHAHARUDIN, M191 - BSN CAWAGAN AMPANG POINT KUALA LUMPUR',
                    listeners: {
                        'render': function() {
                            Ext.create({
                                xtype: 'tooltip',
                                ...
                                listeners: {
                                    ...
                                    beforeshow: function(tip) {
                                        tooltip = this.up().up().getViewModel().get('partnerid') != 0 ? 
                                        this.up().up().getViewModel().get('userid') +' - ' + this.up().up().getViewModel().get('displayname') + ', <br>' + this.up().up().getViewModel().get('partnerid') + ' - ' + this.up().up().getViewModel().get('partnername')
                                        : this.up().up().getViewModel().get('userid') +' - ' + this.up().up().getViewModel().get('displayname');
                                        tip.setHtml(tooltip);
                                    }
                                }
                            });

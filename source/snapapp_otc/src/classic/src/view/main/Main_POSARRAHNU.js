...
Ext.define('snap.view.main.Main_POSARRAHNU', {
    ...
    requires: [
        ...
        'snap.view.main.MainController_POSARRAHNU',
        'snap.view.main.MainModel_POSARRAHNU',
        'snap.view.main.MainContainerWrap_POSARRAHNU',
        'snap.view.main.BlankPage_POSARRAHNU',
    ...
    controller: 'main_POSARRAHNU',
    viewModel: 'main_POSARRAHNU',

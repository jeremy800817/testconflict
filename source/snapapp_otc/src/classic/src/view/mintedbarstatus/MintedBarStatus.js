Ext.define('snap.view.mintedbarstatus.MintedBarStatus', {
    extend: 'Ext.container.Container',
    xtype: 'mintedbarstatusview',
    requires: [
    ...
    listeners: {
        ...
        afterrender: function () {
                    ...
                    items:[
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: '+cardHeight+'px;background-color: #013A6B;background-image: -webkit-linear-gradient(132deg, #F4D03F 0%, #16A085 100%);"><div class="icon" style="color:#ffffff;font-size:6.5em;"><img src="src/resources/images/igr/IGR-White-01.png"></div><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="GS-999-9-0-5g">-</span><div style="color:#ffffff;font-size:1.3em;font-weight: bold;font-size: 2.5rem;">0.5 g</div></div>',
                                    width: '100%',
                                },
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: '+cardHeight+'px;background-color: #013A6B;background-image: -webkit-linear-gradient(30deg, #013A6B 0%, #004E95 100%);"><div class="icon" style="color:#ffffff;font-size:6.5em;"><img src="src/resources/images/igr/IGR-White-02.png"></div><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="GS-999-9-1g">-</span><div style="color:#ffffff;font-size:1.3em;font-weight: bold;font-size: 2.5rem;">1 g</div></div>',
                                    width: '100%',
                                },
                        ...
                        // },
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: '+cardHeight+'px;background-color: #013A6B;background-image: linear-gradient(to right top, #f2e800, #fad000, #ffb700, #ff9e00, #ff8500);"><div class="icon" style="color:#ffffff;font-size:6.5em;"><img src="src/resources/images/igr/IGR-White-04.png"></div><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="GS-999-9-5g">-</span><div style="color:#ffffff;font-size:1.3em;font-weight: bold;font-size: 2.5rem;">5 g</div></div>',
                                    width: '100%',
                                },
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: '+cardHeight+'px;background-color: #013A6B;background-image: linear-gradient(to left bottom, #051937, #004d7a, #008793, #00bf72, #a8eb12);"><div class="icon" style="color:#ffffff;font-size:6.5em;"><img src="src/resources/images/igr/IGR-White-05.png"></div><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="GS-999-9-10g">-</span><div style="color:#ffffff;font-size:1.3em;font-weight: bold;font-size: 2.5rem;">10 g</div></div>',
                                    width: '100%',
                                },
                    ...
                    items:[
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: '+cardHeight+'px;background-color: #013A6B;background-image: -webkit-linear-gradient(90deg, #74EBD5 0%, #9FACE6 100%);"><div class="icon" style="color:#ffffff;font-size:6.5em;"><img src="src/resources/images/igr/IGR-White-06.png"></div><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="GS-999-9-50g">-</span><div style="color:#ffffff;font-size:1.3em;font-weight: bold;font-size: 2.5rem;">50 g</div></div>',
                                    width: '100%',
                                },
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: '+cardHeight+'px;background-color: #013A6B;background-image: -webkit-linear-gradient(43deg, #4158D0 0%, #C850C0 46%, #FFCC70 100%);"><div class="icon" style="color:#ffffff;font-size:6.5em;"><img src="src/resources/images/igr/IGR-White-07.png"></div><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="GS-999-9-100g">-</span><div style="color:#ffffff;font-size:1.3em;font-weight: bold;font-size: 2.5rem;">100 g</div></div>',
                                    width: '100%',
                                },
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: '+cardHeight+'px;background-color: #FFE53B;background-image: linear-gradient(147deg, #FFE53B 0%, #FF2525 74%);"><div class="icon" style="color:#ffffff;font-size:6.5em;"><img src="src/resources/images/igr/IGR-White-10.png"></div><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="GS-999-9-1000g">-</span><div style="color:#ffffff;font-size:1.3em;font-weight: bold;font-size: 2.5rem;">1000 g</div></div>',
                                    width: '100%',
                                },
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: '+cardHeight+'px;background-color: #013A6B;background-image: -webkit-linear-gradient(160deg, #0093E9 0%, #80D0C7 100%);"><div class="icon" style="color:#ffffff;font-size:6.5em;"><img src="src/resources/images/igr/IGR-White-08.png"></div><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="GS-999-9-1-DINAR">-</span><div style="color:#ffffff;font-size:1.3em;font-weight: bold;font-size: 2.5rem;">1 Dinar</div></div>',
                                    width: '100%',
                                },
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: '+cardHeight+'px;background-color: #013A6B;background-image: -webkit-linear-gradient(315deg, #3f0d12 0%, #a71d31 74%);"><div class="icon" style="color:#ffffff;font-size:6.5em;"><img src="src/resources/images/igr/IGR-White-09.png"></div><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="GS-999-9-5-DINAR">-</span><div style="color:#ffffff;font-size:1.3em;font-weight: bold;font-size: 2.5rem;">5 Dinar</div></div>',
                                    width: '100%',
                                },
            ...
            snap.getApplication().sendRequest({
                hdl: 'goldbarstatus', action: 'getSharedMintedList'
            }, 'Fetching data from server....').then(
                function (data) {
                    if (data.success) {
                        // O.5 and 2.5g have diff naming due to pointer not working with .
                        Ext.get('GS-999-9-0-5g').dom.innerHTML = data.zeropointfivegrams;
                        Ext.get('GS-999-9-1g').dom.innerHTML = data.onegram;
                        Ext.get('GS-999-9-2-5g').dom.innerHTML = data.twopointfivegrams;
                        Ext.get('GS-999-9-5g').dom.innerHTML = data.fivegrams;
                        Ext.get('GS-999-9-10g').dom.innerHTML = data.tengrams;
                        Ext.get('GS-999-9-50g').dom.innerHTML = data.fiftygrams;
                        Ext.get('GS-999-9-100g').dom.innerHTML = data.hundredgrams;
                        Ext.get('GS-999-9-1000g').dom.innerHTML = data.thousandgrams;
                        Ext.get('GS-999-9-1-DINAR').dom.innerHTML = data.onedinar;
                        Ext.get('GS-999-9-5-DINAR').dom.innerHTML = data.fivedinar;
    ...
    items: [
...

        {
            ...
            items: [
                {
                    title: 'Minted Bar Inventory List By Denomination',
                    text: 'Download', 
                    tooltip: 'Export Data', 
                    header: {
                        style: 'background-color: #204A6D;border-color: #204A6D;',
                    ...
                    id: 'mintedwarehouseinventory-display',
                    layout: 'vbox',
                    width: '100%',
                    header: {
                        ...
                        items: [{
                            ...
                            id: 'minted-warehouse-download-button',
                            ...
                            listeners : {
                                ...
                                click: {
                                    ...
                                    fn: function(){ 
                                        ...
                                        Ext.getCmp('minted-warehouse-download-button').me.exportMintedListButton('GS-999-9');
                                    }
                                },
                            }
                        }]

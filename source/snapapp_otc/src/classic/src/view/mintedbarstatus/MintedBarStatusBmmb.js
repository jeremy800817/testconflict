Ext.define('snap.view.mintedbarstatus.MintedBarStatusBmmb', {
    extend: 'Ext.container.Container',
    xtype: 'mintedbarstatusbmmbview',
    requires: [
    ...
    permissionRoot: '/root/bmmb/mintedbar',
    partnercode: 'BMMB',
    layout: {
        type: 'vbox',
        align: 'center'
    ...
    listeners: {
        ...
        afterrender: function () {
            ...
            var panel = Ext.getCmp('bmmb-mintedwarehouseinventory-display');
            var button = Ext.getCmp('bmmb-minted-warehouse-download-button');
    ...
    items: [
...

        {
            ...
            items: [
                {
                    title: 'Minted Bar Inventory List By Denomination for Easigold',
                    text: 'Download', 
                    tooltip: 'Export Data', 
                    header: {
                        style: 'background-color: #204A6D;border-color: #204A6D;',
                    ...
                    id: 'bmmb-mintedwarehouseinventory-display',
                    layout: 'vbox',
                    width: '100%',
                    header: {
                        ...
                        items: [{
                            ...
                            id: 'bmmb-minted-warehouse-download-button',
                            ...
                            listeners : {
                                ...
                                click: {
                                    ...
                                    fn: function(){ 
                                        ...
                                        Ext.getCmp('bmmb-minted-warehouse-download-button').me.exportMintedListButton('GS-999-9');
                                    }
                                },
                            }
                        }]

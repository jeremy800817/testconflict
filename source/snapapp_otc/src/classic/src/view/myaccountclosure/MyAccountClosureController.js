Ext.define('snap.view.myaccountclosure.MyAccountClosureController', {
    extend: 'snap.view.gridpanel.BaseController',
    alias: 'controller.myaccountclosure-myaccountclosure',
    ...
    getPrintReport: function (btn) {
        ...
        url = '?hdl=myaccountclosure&action=exportExcel&header=' + header + '&daterange=' + daterange + '&partnercode=' + this.getView().partnercode;
    ...
    getDateRange: function () {
        ...
        {
            property: "requestedon", type: "date", operator: "BETWEEN", value: [startDate, endDate]
        },
        )
    },
  ...
  onGetItemDetail: function( record, column) {
      ...
      if (column.dataIndex === 'status') {
          ...
          else if (value == '1') value = 'Approved';
          else if (value == '2') value = 'Rejected';
          else if (value == '3') value = 'In Progress';
  ...
  getPrintReportKtp: function (){
    ...
    if(!startDate || !endDate){
      ...
      snap.getApplication().sendRequest({
        hdl: 'myaccountclosure', action: 'getMerchantList', partnercode: myView.partnercode,
  ...
  GenerateReport: function(selectedID){
    ...
    elmnt.getView('grid').getColumns().map(column => {
      ...
      header = encodeURIComponent(JSON.stringify(header));
      daterange = encodeURIComponent(JSON.stringify(daterange));
      url = '?hdl=myaccountclosure&action=exportExcel&header=' + header + '&daterange=' + daterange + '&partnercode=' + myView.partnercode +'&selected='+selectedID;

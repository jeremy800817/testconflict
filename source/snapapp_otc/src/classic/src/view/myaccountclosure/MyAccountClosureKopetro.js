Ext.define('snap.view.myaccountclosure.MyAccountClosureKopetro', {
    extend: 'snap.view.myaccountclosure.MyAccountClosure',
    xtype: 'mykopetroaccountclosureview',
    partnercode: 'KOPETRO',
    permissionRoot: '/root/kopetro/accountclosure',
    store: {
        type: 'MyAccountClosure', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myaccountclosure&action=list&partnercode=KOPETRO',
            reader: {
                type: 'json',

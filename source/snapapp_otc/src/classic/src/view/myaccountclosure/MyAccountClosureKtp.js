Ext.define('snap.view.myaccountclosure.MyAccountClosureKtp', {
    extend: 'snap.view.myaccountclosure.MyAccountClosure',
    xtype: 'myktpaccountclosureview',
    partnercode: 'KTP',
    permissionRoot: '/root/kpt/accountclosure',
    store: {
        type: 'MyAccountClosure', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myaccountclosure&action=list&partnercode=KTP',
            reader: {
                type: 'json',

Ext.define('snap.view.myaccountholder.MyAccountHolder', {
    ...
    columns: [
        ...
        renderer: function (value, rec) {
            ...
            else if (value == '21') return 'Company';
            else if (value == '22') return 'Coheading';
            else if (value == '23') return 'Sole Prioprietorship';
            else if (value == '24') return 'Individual';

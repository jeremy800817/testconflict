Ext.define('snap.view.myaccountholder.MyAccountHolderNubex', {
    extend: 'snap.view.myaccountholder.MyAccountHolder',
    xtype: 'myaccountholdernubexview',
    ...
    permissionRoot: '/root/nubex/profile',
    store: {
        type: 'MyAccountHolder',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myaccountholder&action=list&partnercode=NUBEX',
            reader: {
                type: 'json',

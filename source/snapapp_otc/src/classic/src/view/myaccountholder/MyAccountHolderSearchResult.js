Ext.define('snap.view.myaccountholder.MyAccountHolderSearchResult', {
    ...
    toolbarItems: [
        'detail', '|', 'filter', '|',
        { reference: 'profileBtn', handler: 'onViewAccountHolder', text: 'CIF', showToolbarItemText: true, itemId: 'profileBtn', tooltip: 'Account Holder Profile', viewType: 'myprofileview', iconCls: 'x-fa fa-user', validSelection: 'single', hidden:true },
        ...
        {
            style : "width : 130px;", text: 'Download', tooltip: 'Export Data', iconCls: 'x-fa fa-download', handler: 'getPrintReportFromSearch',  showToolbarItemText: true, printType: 'xlsx', labelWidth:'auto'// printType: pending
        },
    ],
    columns: [
        ...
        { text: 'Occupation Sub Category', dataIndex: 'occupationsubcategory', filter: { type: 'string' }, hidden: true, minWidth: 130, flex: 1 },
        // { text: 'Occupation Category ID', dataIndex: 'occupationsubcategoryid', filter: { type: 'string' }, hidden: true, minWidth: 130, flex: 1 },
        ...
        { text: 'Bank Account Balance', dataIndex: 'accountbalance', exportdecimal:2, filter: { type: 'string' }, minWidth: 130, flex: 1, renderer: Ext.util.Format.numberRenderer('0.00') },

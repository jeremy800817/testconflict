Ext.define('snap.view.myaccountholder.MyAccountHolderWavpay', {
    extend: 'snap.view.myaccountholder.MyAccountHolder',
    xtype: 'myaccountholderwavpayview',
    ...
    permissionRoot: '/root/wavpay/profile',
    store: {
        type: 'MyAccountHolder',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myaccountholder&action=list&partnercode=WAVPAY',
            reader: {
                type: 'json',

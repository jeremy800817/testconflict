Ext.define('snap.view.myaccountholder.MyAccountHolder_BSN', {
    extend:'Ext.panel.Panel',
    xtype: 'myaccountholderview_BSN',
                ...
                items: [
                        ...
                        { 
                            ...
                            toolbarItems: [
                                ...
                                {
                                    text: 'Print', cls: '', tooltip: 'Print', validSelection: 'single', iconCls: 'x-fa fa-print', reference: 'printRegisterPDF', handler: 'printRegisterPDF',  showToolbarItemText: true, printType: 'xlsx', // printType: pending
                                },
                            ],
                            ...
                            columns: [
                                ...
                                { text: 'Branch Code', dataIndex: 'partnercode', filter: { type: 'string' }, hidden: true, minWidth: 130, flex: 1 },
                                ...
                                //     },
                                // },
                                { text: 'Transaction Purpose', dataIndex: 'loanreference', filter: { type: 'string' }, minWidth: 130, flex: 1 },
                                {

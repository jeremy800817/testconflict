Ext.define('snap.view.mycommission.MyCommissionBumiraNonPeak', {
    extend: 'snap.view.mycommission.MyCommissionBumira',
    xtype: 'mybumiracommissionnonpeakview',
    partnercode: 'BUMIRA',
    nonpeak: true,
    permissionRoot: '/root/bumira/report/commission',
    store: {
        type: 'MyCommission', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mycommission&action=list&partnercode=BUMIRA&nonpeak=true',
            reader: {
                type: 'json',

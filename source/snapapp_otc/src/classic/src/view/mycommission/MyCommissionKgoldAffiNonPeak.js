Ext.define('snap.view.mycommission.MyCommissionKgoldAffiNonPeak', {
    extend: 'snap.view.mycommission.MyCommissionKgoldAffi',
    xtype: 'mykgoldafficommissionnonpeakview',
    ...
    store: {
        type: 'MyCommission', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mycommission&action=list&partnercode=KGOLDAFFI&nonpeak=true',
            reader: {
                type: 'json',

Ext.define('snap.view.mycommission.MyCommissionKodimasNonPeak', {
    extend: 'snap.view.mycommission.MyCommissionKodimas',
    xtype: 'mykodimascommissionnonpeakview',
    partnercode: 'KODIMAS',
    nonpeak: true,
    permissionRoot: '/root/kodimas/report/commission',
    store: {
        type: 'MyCommission', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mycommission&action=list&partnercode=KODIMAS&nonpeak=true',
            reader: {
                type: 'json',

Ext.define('snap.view.mycommission.MyCommissionKopttrNonPeak', {
    extend: 'snap.view.mycommission.MyCommissionKopttr',
    xtype: 'mykopttrcommissionnonpeakview',
    partnercode: 'KOPTTR',
    nonpeak: true,
    permissionRoot: '/root/kopttr/report/commission',
    store: {
        type: 'MyCommission', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mycommission&action=list&partnercode=KOPTTR&nonpeak=true',
            reader: {
                type: 'json',

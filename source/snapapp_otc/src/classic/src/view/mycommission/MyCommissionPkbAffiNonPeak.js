Ext.define('snap.view.mycommission.MyCommissionPkbAffiNonPeak', {
    extend: 'snap.view.mycommission.MyCommissionPkbAffi',
    xtype: 'mypkbafficommissionnonpeakview',
    partnercode: 'PKBAFFI',
    nonpeak: true,
    permissionRoot: '/root/pkbaffi/report/commission',
    store: {
        type: 'MyCommission', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mycommission&action=list&partnercode=PKBAFFI&nonpeak=true',
            reader: {
                type: 'json',

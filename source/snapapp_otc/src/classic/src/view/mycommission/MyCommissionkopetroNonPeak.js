Ext.define('snap.view.mycommission.MyCommissionKopetroNonPeak', {
    extend: 'snap.view.mycommission.MyCommissionKopetro',
    xtype: 'mykopetrocommissionnonpeakview',
    partnercode: 'KOPETRO',
    nonpeak: true,
    permissionRoot: '/root/kopetro/report/commission',
    store: {
        type: 'MyCommission', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mycommission&action=list&partnercode=KOPETRO&nonpeak=true',
            reader: {
                type: 'json',

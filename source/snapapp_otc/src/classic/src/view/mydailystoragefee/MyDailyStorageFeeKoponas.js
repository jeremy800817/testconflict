Ext.define('snap.view.mydailystoragefee.MyDailyStorageFeeKoponas', {
    extend: 'snap.view.mydailystoragefee.MyDailyStorageFee',
    xtype: 'mykoponasdailystoragefeeview',
    ...
    store: {
        type: 'MyDailyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mydailystoragefee&action=list&partnercode=KOPONAS',
            reader: {
                type: 'json',

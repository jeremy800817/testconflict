Ext.define('snap.view.mydailystoragefee.MyDailyStorageFeeKopttr', {
    extend: 'snap.view.mydailystoragefee.MyDailyStorageFee',
    xtype: 'mykopttrdailystoragefeeview',
    ...
    store: {
        type: 'MyDailyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mydailystoragefee&action=list&partnercode=KOPTTR',
            reader: {
                type: 'json',

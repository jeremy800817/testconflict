Ext.define('snap.view.mydailystoragefee.MyDailyStorageFeeKtp', {
    extend: 'snap.view.mydailystoragefee.MyDailyStorageFee',
    xtype: 'myktpdailystoragefeeview',
    ...
    store: {
        type: 'MyDailyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mydailystoragefee&action=list&partnercode=KTP',
            reader: {
                type: 'json',

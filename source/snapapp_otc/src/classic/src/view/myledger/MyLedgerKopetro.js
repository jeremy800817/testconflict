Ext.define('snap.view.myledger.MyLedgerKopetro', {
    extend: 'snap.view.myledger.MyLedger',
    xtype: 'myledgerkopetroview',
    ...
    permissionRoot: '/root/kopetro/promo',
    store: {
        type: 'MyLedger',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myledger&action=list&partnercode=KOPETRO',
            reader: {
                type: 'json',

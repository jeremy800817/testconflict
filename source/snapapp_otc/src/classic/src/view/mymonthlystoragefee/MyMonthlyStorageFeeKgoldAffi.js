Ext.define('snap.view.mymonthlystoragefee.MyMonthlyStorageFeeKgoldAffi', {
    extend: 'snap.view.mymonthlystoragefee.MyMonthlyStorageFee',
    xtype: 'mykgoldaffimonthlystoragefeeview',

    partnercode: 'KGOLDAFFI',
    permissionRoot: '/root/kgoldaffi/report/storagefee',
    store: {
        type: 'MyMonthlyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlystoragefee&action=list&partnercode=KGOLDAFFI',
            reader: {
                type: 'json',

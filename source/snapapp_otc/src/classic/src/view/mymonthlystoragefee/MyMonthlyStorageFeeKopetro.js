Ext.define('snap.view.mymonthlystoragefee.MyMonthlyStorageFeeKopetro', {
    extend: 'snap.view.mymonthlystoragefee.MyMonthlyStorageFee',
    xtype: 'mykopetromonthlystoragefeeview',
    ...
    store: {
        type: 'MyMonthlyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlystoragefee&action=list&partnercode=KOPETRO',
            reader: {
                type: 'json',

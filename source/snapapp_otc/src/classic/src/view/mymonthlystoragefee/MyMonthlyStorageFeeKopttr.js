Ext.define('snap.view.mymonthlystoragefee.MyMonthlyStorageFeeKopttr', {
    extend: 'snap.view.mymonthlystoragefee.MyMonthlyStorageFee',
    xtype: 'mykopttrmonthlystoragefeeview',

    partnercode: 'KOPTTR',
    permissionRoot: '/root/kopttr/report/storagefee',
    store: {
        type: 'MyMonthlyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlystoragefee&action=list&partnercode=KOPTTR',
            reader: {
                type: 'json',
    ...
    toolbarItems: [
        ...
        {
            text: 'Print', tooltip: 'Print Report', iconCls: 'x-fa fa-print', handler: 'getPrintReportKopttr', showToolbarItemText: true, printType: 'xlsx', // printType: pending
        },
        {

Ext.define('snap.view.mymonthlystoragefee.MyMonthlyStorageFeePkbAffi', {
    extend: 'snap.view.mymonthlystoragefee.MyMonthlyStorageFee',
    xtype: 'mypkbaffimonthlystoragefeeview',
    ...
    store: {
        type: 'MyMonthlyStorageFee', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlystoragefee&action=list&partnercode=PKBAFFI',
            reader: {
                type: 'json',

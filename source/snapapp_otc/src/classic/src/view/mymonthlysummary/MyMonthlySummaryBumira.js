Ext.define('snap.view.mymonthlysummary.MyMonthlySummaryBumira', {
    extend: 'snap.view.mymonthlysummary.MyMonthlySummary',
    xtype: 'mybumiramonthlysummaryview',
    partnercode: 'BUMIRA',
    store: {
        type: 'MyMonthlySummary', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlysummary&action=list&partnercode=BUMIRA',
            reader: {
                type: 'json',
    ...
    toolbarItems: [
        ...
        { reference: 'printSummaryBtn', handler: 'getPrintReportBumira', text: 'Print Summary', itemId: 'printSummaryBtn', tooltip: 'Print Summary', iconCls: 'x-fa fa-print', validSelection: 'ignore', showToolbarItemText: true },

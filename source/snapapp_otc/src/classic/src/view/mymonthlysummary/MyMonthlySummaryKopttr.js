Ext.define('snap.view.mymonthlysummary.MyMonthlySummaryKopttr', {
    extend: 'snap.view.mymonthlysummary.MyMonthlySummary',
    xtype: 'mykopttrmonthlysummaryview',
    partnercode: 'KOPTTR',
    store: {
        type: 'MyMonthlySummary', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mymonthlysummary&action=list&partnercode=KOPTTR',
            reader: {
                type: 'json',
    ...
    toolbarItems: [
        ...
        { reference: 'printSummaryBtn', handler: 'getPrintReportKopttr', text: 'Print Summary', itemId: 'printSummaryBtn', tooltip: 'Print Summary', iconCls: 'x-fa fa-print', validSelection: 'ignore', showToolbarItemText: true },

Ext.define('snap.view.mytransfergold.MyTransferGoldKgoldaffi', {
    extend: 'snap.view.mytransfergold.MyTransferGold',
    xtype: 'mytransfergoldkgoldaffiview',
    ...
    permissionRoot: '/root/kgoldaffi/transfergold',
    store: {
        type: 'MyTransferGold',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mytransfergold&action=list&partnercode=KGOLDAFFI',
            reader: {
                type: 'json',

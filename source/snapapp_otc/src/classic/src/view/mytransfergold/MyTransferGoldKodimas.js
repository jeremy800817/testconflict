Ext.define('snap.view.mytransfergold.MyTransferGoldKodimas', {
    extend: 'snap.view.mytransfergold.MyTransferGold',
    xtype: 'mytransfergoldkodimasview',
    ...
    permissionRoot: '/root/kodimas/transfergold',
    store: {
        type: 'MyTransferGold',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mytransfergold&action=list&partnercode=KODIMAS',
            reader: {
                type: 'json',

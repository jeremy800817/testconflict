Ext.define('snap.view.mytransfergold.MyTransferGoldKopetro', {
    extend: 'snap.view.mytransfergold.MyTransferGold',
    xtype: 'mytransfergoldkopetroview',
    ...
    permissionRoot: '/root/kopetro/transfergold',
    store: {
        type: 'MyTransferGold',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mytransfergold&action=list&partnercode=KOPETRO',
            reader: {
                type: 'json',

Ext.define('snap.view.mytransfergold.MyTransferGoldKoponas', {
    extend: 'snap.view.mytransfergold.MyTransferGold',
    xtype: 'mytransfergoldkoponasview',
    ...
    permissionRoot: '/root/koponas/transfergold',
    store: {
        type: 'MyTransferGold',
        proxy: {
            type: 'ajax',
            url: 'index.php?hdl=mytransfergold&action=list&partnercode=KOPONAS',
            reader: {
                type: 'json',

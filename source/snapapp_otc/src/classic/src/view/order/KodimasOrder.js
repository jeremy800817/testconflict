Ext.define('snap.view.order.KodimasOrder', {
    extend: 'snap.view.order.MyOrder',
    xtype: 'kodimasorderview',
    requires: [
    ...
    partnercode: 'KODIMAS',
    permissionRoot: '/root/kodimas/goldtransaction',
    store: {
        type: 'MyOrder', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=myorder&action=list&partnercode=KODIMAS',
            reader: {
                type: 'json',

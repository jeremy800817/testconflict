Ext.define('snap.view.order.OtcOrder', {
    ...
    columns: [
        ...
        { text: 'Gold Account No', dataIndex: 'dbmpdtaccountholdercode', filter: { type: 'string' }, minWidth: 130, hidden:true,
            renderer: function (value, rec, rowrec) {
                // console.log(rec,rowrec,'rec')
        ...
        {
            text: 'Commission Amount', dataIndex: 'pricedifference', exportdecimal:2, filter: { type: 'string' },  align: 'right', minWidth: 80, renderer: Ext.util.Format.numberRenderer('0,000.00'),
            editor: {    //field has been deprecated as of 4.0.5
                xtype: 'numberfield',
                decimalPrecision: 2
            }

Ext.define('snap.view.orderdashboard.Dashboard_POSARRAHNU',{
    extend: 'Ext.panel.Panel',
    xtype: 'dashboardview_POSARRAHNU',
    ...
    items: {
        ...
        items: [
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            // value: '3.98g',
                                            width: '100%',
                                            fieldCls: 'otc-displayfield-large-text-dashboard-left',
                                            value: '88k',
                                            bind: {
                                                value: '{'+PROJECTBASE + '_CHANNEL.accountholderdata}',
                                            },
                                        },
                                        {
                                            xtype: 'displayfield',
                                            value: '+16.00%',
                                            width: '100%',
                                            fieldCls: 'otc-displayfield-small-text-dashboard-left',
            ...
            },
            {
                ...
                {
                    xtype: 'panel',
                    reference: 'totalcustomerholdingpanel',
                    cls: 'otc-main-left',
                    // hidden: true,
                    header: false,
                    flex: 13,

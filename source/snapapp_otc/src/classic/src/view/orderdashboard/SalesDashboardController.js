Ext.define('snap.view.orderdashboard.SalesDashboardController', {
    extend: 'snap.view.gridpanel.BaseController',
    alias: 'controller.salesdashboard-salesdashboard',
...
`       */
    ...
    /*
    _printOrderPDFSpotSpecialSell: function(btn, customerid) {
        // var owningWindow = btn.up('window');
        // var gridFormPanel = owningWindow.down('form');
        var me = this;
        ...
        var url = 'index.php?hdl=order&action=printSpotOrderSellSpecial&product='+product+'&finalprice='+finalprice+'&xauweight='+xauweight+'&totalestvalue='+totalestvalue+'&orderid='+orderid+'&customerid='+customerid;
				Ext.Ajax.request({
					url: url,
					method: 'get',
					waitMsg: 'Processing',

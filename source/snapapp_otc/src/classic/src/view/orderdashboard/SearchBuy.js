...
Ext.define('snap.view.orderdashboard.SearchBuy',{
                ...
                items: [
                {
                    ...
                    listeners: {
                        afterrender: function(form) {
                          var hasBuyGoldPermission = snap.getApplication().hasPermission('/root/alrajhi/search/buy');
                    ...
                    dockedItems: [{
                        ...
                        items: [{
                            ...
                            handler: function (button) {
                                ...
                                var buyNowWindow = Ext.create('Ext.window.Window', {
                                    title: 'Buy Now Confirmation',
                                    width: 400,
                                    height: 150,
                                    layout: 'center',
                                    modal: true,
                                    items: [{
                                        ...
                                        items: [{
                                            ...
                                            margin: '0 10 0 0',
                                            handler: function () {
                                                elmnt.doBiometricValidation(button, 'doSpotOrderBuyOTC', 'Buy');
                                                buyNowWindow.close();
                                            }
                                        }, {
                                            xtype: 'button',
                                            ...
                                            handler: function () {
                                                elmnt.doBiometricSkip(button, 'doSpotOrderBuyOTC',  '0' , 'Buy');
                                                buyNowWindow.close();
                                            }
                                        }]
                                    }]

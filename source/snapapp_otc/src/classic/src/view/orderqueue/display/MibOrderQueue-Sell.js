Ext.define('snap.view.orderqueue.display.MibOrderQueue-Sell',{
    extend: 'snap.view.orderqueue.MibOrderQueue',
    xtype: 'miborderqueuesellview',

    //permissionRoot: '/root/mbb/ftrorder',
    store: { type: 'MibOrderQueue', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=miborderqueue&action=list&type=CompanySell',
            reader: {
                type: 'json',
        ...
        remoteFilter: true,
        filters: [
            { property: 'ordertype',value: 'CompanySell'},
    ...
    columns: [
        ...
        { text: 'Matched Price (RM)',  dataIndex: 'companysellppg', filter: {type: 'string'} ,minWidth:100, align: 'right', renderer: Ext.util.Format.numberRenderer('0,000.000'),
        editor: {    //field has been deprecated as of 4.0.5
            xtype: 'numberfield',
            decimalPrecision: 3
        } }, 

// Init searchfield
Ext.define('snap.view.tnc.Terms_POSARRAHNU',{
    extend: 'Ext.panel.Panel',
    xtype: 'tncview_POSARRAHNU',
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'togglebutton',
                                    fieldLabel:  getText('agreetnc'),
                                    labelAlign : 'center',
                                    value: 0,
                                    // labelWidth: 130,
                                    labelWidth: 350,
                                    minWidth: 350,
                                    cls: 'otc-toggle-center',
                                    listeners: {
                                     changecomplete: function (slider, newValue, thumb, eOpts){
                                            // 'do the required action'
                                            // if value = yes, enable button
                                            form = this.up().up().up();
                                            button = form.dockedItems.items[0].items.items[0];

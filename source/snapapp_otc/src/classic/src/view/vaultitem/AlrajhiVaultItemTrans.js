Ext.define('snap.view.vaultitemtrans.AlrajhiVaulItemTrans', {
    extend: 'snap.view.vaultitemtrans.vaultitemTrans',
    xtype: 'alrajhivaultitemtransview',
    requires: [
    ...
    store: {
        type: 'VaultItemTrans', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=vaultitemtrans&action=list&partnercode=ALRAJHI',
            reader: {
                type: 'json',
    ...
    permissionRoot: '/root/alrajhi/vault',
    enableFilter: true,
    type: 'alrajhi',
    partnerCode: 'ALRAJHI',
    toolbarItems: [
    ...
    checkActionPermission: function (view, record) {
        ...
        var transferPermission = snap.getApplication().hasPermission('/root/alrajhi/vault/transfer');
        var returnPermission = snap.getApplication().hasPermission('/root/alrajhi/vault/return');

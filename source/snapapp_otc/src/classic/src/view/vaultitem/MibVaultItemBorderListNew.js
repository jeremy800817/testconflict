Ext.define('snap.view.vaultitem.MibVaultItemBorderListNew', { // _CHANGE
    extend: 'snap.view.vaultitem.vaultitemBorderList',
    xtype: 'mibvaultitem-border-new', // _CHANGE
    partnerCode : 'MIB',
    requires: [
            ...
            snap.getApplication().sendRequest({
                ...
                function (data) {
                    if (data.success) {
                        ...
                        vmv.set('mibg4sserialnumbers', data.mbbg4sserialnumbers);
                        ...
                        Ext.get('mibvaultamount').dom.innerHTML = data.vaultAmount;
                        Ext.get('mibtotalutilization').dom.innerHTML = data.totalUtilization;
                        Ext.get('mibwithoutdoxau').dom.innerHTML = data.withoutDoXau;
                        // Set Status
    ...
    items: [
        {
            ...
            items: [
                ...
                {
                    html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#ffb91b"><span style="color:#ffffff;font-size:1.5em;font-weight:900;width:100%;height:300px" id="'+'mibtotalutilization'+'">-</span><div style="color:#ffffff;font-size:0.9em;">Total Utilization (g)</div></div>',
                    width: '100%',
                    height: '33%',
                    flex: 1,
                },
                {
                    html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#00529B"><span style="color:#ffffff;font-size:1.5em;font-weight:900;width:100%;height:300px" id="'+'mibwithoutdoxau'+'">-</span><div style="color:#ffffff;font-size:1.2em;">Without DO Number (g)</div></div>',
                    width: '100%',
                    height: '33%',
                    flex: 1,
                },
                {
                    html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#ffb91b"><span style="color:#ffffff;font-size:1.5em;font-weight:900;width:100%;height:300px" id="'+'mibvaultamount'+'">-</span><div style="color:#ffffff;font-size:1.2em;">'+'MIB'+' Vault (g)</div></div>',
                    width: '100%',
                    height: '33%',
                    flex: 1,
                },
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#62059E"><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="mibwithdocount">-</span><div style="color:#ffffff;font-size:1.3em;">With Delivery Order</div></div>',
                                    width: '100%',
                                },
                        ...
                        },
                        {
                            ...
                            items: [
                                {   
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#AB04C5"><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="mibwithoutdocount">-</span><div style="color:#ffffff;font-size:1.3em;">Without Delivery Order</div></div>',
                                    width: '100%',
                                    tooltip: 'Queue Order',
                                    listeners : {
                                        render: function(p) {
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#0A9DB3"><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="mibtransferringcount">-</span><div style="color:#ffffff;font-size:1.3em;">CURRENTLY IN TRANSFERRING</div></div>',
                                    width: '100%',
                                },
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#0D47A1"><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="mibvaultreservedcount">-</span><div style="color:#ffffff;font-size:1.3em;">RESERVED</div></div>',
                                    width: '100%',
                                    listeners : {
                                        click: {
                                            element: 'el', //bind to the underlying el property on the panel
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#ffb91b"><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="mibvaultaceg4scount">-</span><div style="color:#ffffff;font-size:1.3em;">G4S-ACE</div></div>',
                                    width: '100%',
                                    listeners : {
                                        click: {
                                            element: 'el', //bind to the underlying el property on the panel
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#1aa124"><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="mibvaultmbbg4scount">-</span><div style="color:#ffffff;font-size:1.3em;">G4S-MBB</div></div>',
                                    width: '100%',
                                    listeners : {
                                        click: {
                                            element: 'el', //bind to the underlying el property on the panel
                                            fn: function(){ 
                                                ...
                                                if(vmv.get('mibg4sserialnumbers').length != 0){
                                                    windowforserialnumberinventory.show();
                                                
                                            
                                                    element = vmv.get('element');
                                                    var panel = Ext.getCmp('mibg4sserialnumbers');
            
                                                    //date = data.createdon.date;
                                                    //filtereddate = Ext.Date.format(new Date(date), "Y-m-d");
                                                    panel.removeAll();
                                                    vmv.get('mibg4sserialnumbers').map((x) => {
                                                    ...
                                                    Ext.getCmp('mibg4sserialnumbers').destroy();
                                                }
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    html: '<div style="text-align: center;vertical-align: middle;line-height: 40px;background:#B71C1C"><span style="color:#ffffff;font-size:3em;font-weight:900;width:100%" id="mibvaulttotalcount">-</span><div style="color:#ffffff;font-size:1.3em;">TOTAL</div></div>',
                                    width: '100%',
                                    listeners : {
                                        click: {
                                            element: 'el', //bind to the underlying el property on the panel

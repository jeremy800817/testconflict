Ext.define('snap.view.vaultitem.MibVaulItemList', {
    ...
    allowDeselect:true,
    store: { type: 'MibVaultItem'},
    permissionRoot: '/root/mbb/vault',
    enableFilter: true,
    toolbarItems: [
        'detail','filter', '|',
        { reference: 'reqtransferbutton',text: 'Transfer Item', itemId: 'transferitem',iconCls: 'fa fa-arrows-alt-h', handler: 'showTransferForm', validSelection: 'multiple' },
        ...
        { text: 'Return To HQ', tooltip: 'Return kilobar from MBB to HQ', reference: 'returntohqbutton', itemId: 'returnToHQ', text: 'Return to HQ', iconCls: 'fa fa-home', handler: 'returnToHQ', showToolbarItemText: true, validSelection: 'single' },
        {
        ...
        '|',
        { reference: 'printButton', text: 'Print Document', itemId: 'printButton', tooltip: 'Print Documents', iconCls: 'x-fa fa-print', handler: 'printDocumentSelection', validSelection: 'single' },
        { reference: 'createPrintButton', text: 'Create Document', itemId: 'createPrintButton', tooltip: 'Create Document for Print', iconCls: 'x-fa fa-book', handler: 'createPrintButton', validSelection: 'single' },
    ],

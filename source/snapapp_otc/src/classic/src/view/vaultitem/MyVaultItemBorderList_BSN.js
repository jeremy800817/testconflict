Ext.define('snap.view.vaultitem.MyVaultItemBorderList_BSN', {
    extend: 'snap.view.vaultitem.vaultitemBorderList',
    xtype: 'myvaultitemborder_BSN',
    requires: [
                                    ...
                                    items: [
                                        {
                                            ...
                                            items: [
                                                {
                                                    html: '<div style="line-height: 10px;background:#0FCC87;padding:5px;text-align:center"><span style="color:#ffffff;width:100%;">ACE</span></div>',
                                                    width: '100%',
                                                },
                ...
                },
                {
                    ...
                    store: {
                        type: 'MyVaultItem', proxy: {
                            type: 'ajax',
                            url: 'index.php?hdl=myvaultitem&action=getVaultDataPartner&partnercode='+partnerCode,

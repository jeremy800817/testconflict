Ext.define('snap.view.vaultitemtrans.PosarrahnuVaulItemTrans', {
    extend: 'snap.view.vaultitemtrans.vaultitemTrans',
    xtype: 'posarrahnuvaultitemtransview',
    requires: [
    ...
    allowDeselect: true,
    store: {
        type: 'VaultItemTrans', proxy: {
            type: 'ajax',
            url: 'index.php?hdl=vaultitemtrans&action=list&partnercode=POSARRAHNU',
            reader: {
                type: 'json',
    ...
    permissionRoot: '/root/posarrahnu/vault',
    enableFilter: true,
    type: 'posarrahnu',
    ...
    checkActionPermission: function (view, record) {
        ...
        var transferPermission = snap.getApplication().hasPermission('/root/posarrahnu/vault/transfer');
        var returnPermission = snap.getApplication().hasPermission('/root/posarrahnu/vault/return');

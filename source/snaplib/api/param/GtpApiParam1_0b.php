 ...
 */
class GtpApiParam1_0b extends GtpApiParam
{
    /**
    ...
    protected function __construct()
    {
        ...
        $this->registerParameter('spotOrderResponse', 'weight', '', '', 'toConvertXauBursa|order|xau');
        ...
        $this->registerParameter('redemptionResponse', 'redemption_item', '', '', 'toRedemptionItemsBursa|redemption');
        ...
        $this->registerParameter('getlogisticstatus', 'version', 'required;string|max=5;signature|required', '', '');
        $this->registerParameter('getlogisticstatus', 'merchant_id', 'required;partnerCode;signature|required', 'toPartner', '');
        $this->registerParameter('getlogisticstatus', 'action', 'contains|getlogisticstatus;signature|required', '', '');
        $this->registerParameter('getlogisticstatus', 'ref_id', 'required;string|max=12;signature|required', '', '');

        $this->registerParameter('getlogisticstatusResponse', 'version', '', '', 'fromRequest|version');
        $this->registerParameter('getlogisticstatusResponse', 'action_requested', '', '', 'fromRequest|action');
        $this->registerParameter('getlogisticstatusResponse', 'status', '', '', 'constant|1');
        $this->registerParameter('getlogisticstatusResponse', 'ref_id', '', '', 'fromRequest|ref_id');
        $this->registerParameter('getlogisticstatusResponse', 'awbno', '', '', 'fromObject|logistic|awbno');
        $this->registerParameter('getlogisticstatusResponse', 'logistic_status', '', '', 'fromResult|logstatus');
        $signatureBuildingOptions = 'version=required|action_requested=required|status=required|ref_id=required|' .
            'awbno=required|logistic_status=required';
        $this->registerParameter('getlogisticstatusResponse', 'digest', '', '', 'makeGtpSignature|' . $signatureBuildingOptions);
    }
}

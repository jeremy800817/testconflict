 ...
 */
class SapApiParam1_0m extends ApiParam
{
    public function __construct() { 
       foreach(['companyBuyDigitalOrder' => 'sapcompanybuycode1', 
            ...
            $this->registerParameter($action, 'customerId', '', null, 'constant|MIB');
        ...
        // 2023-07-20: update miga redemptionbranch api to set whscode = MIB_BNK instead of null as per discussion in sap technical group
        // $this->registerParameter('redemptionbranch', 'whsCode', '', null, 'constant|__null__');
        $this->registerParameter('redemptionbranch', 'whsCode', '', null, 'constant|MIB_BNK');
        ...
        $this->registerParameter('redemptionbranch', 'customerId', '', null, 'constant|MIB');
        ...
        $this->registerParameter('redemptiondelivery', 'whsCode', '', null, 'constant|__null__');
        ...
        $this->registerParameter('redemptiondelivery', 'customerId', '', null, 'constant|MIB');
        ...
        $this->registerParameter('redemptionspdelivery', 'customerId', '', null, 'constant|MIB');
        ...
        $this->registerParameter('redemptionpreappointment', 'customerId', '', null, 'constant|MIB');
        ...
        $this->registerParameter('buybackminted', 'customerId', '', null, 'constant|MIB');
        ...
        $this->registerParameter('tfreplenish', 'customerId', '', null, 'constant|MIB');
        ...
        $this->registerParameter('tfreturn', 'customerId', '', null, 'constant|MIB');

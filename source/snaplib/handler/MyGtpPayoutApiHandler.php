 ...
 * @version 1.0
 */
class MyGtpPayoutApiHandler implements \Snap\IHandler {
    use TLogging;
    private $app = null;
    ...
    public function doAction($app, $action, $params)
    {
        ...
        if (defined('FPX_HANDLER_CLASS')) {
            try {
                ...
                $handlerClass = BasePayout::getInstance($fpxClassString);
                $data = $handlerClass->handleResponse($params, $postData);

 ...
 * @package  snap.job
 */
class ProcessMintedSharedReportJob extends basejob {
    ...
    public function doJob($app, $params = array()) {
        ...
        if($filename == 'dailyminted'){
            $mintedShared = $app->apiManager()->sapSharedMintedReport($version);
        }

        /*send for report*/
        $getManager->createSharedMintedReport($currentdate,$filename,$reportpath,$emaillist,$emailout,$mintedShared);
    }

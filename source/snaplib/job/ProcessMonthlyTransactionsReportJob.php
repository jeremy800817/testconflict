 ...
 * @package  snap.job
 */
class ProcessMonthlyTransactionsReportJob extends basejob {
    ...
    public function doJob($app, $params = array()) {
        ...
        */
        ...
        if(isset($params['customizepartner'])) $reportname = $params['customizepartner']."_".strtoupper($modulename)."(".$startDateReport."-".$endDateReport.")";
        else $reportname = $pCode."_".strtoupper($modulename)."(".$startDateReport."-".$endDateReport.")";

...
class QueueManager 
{
    ...
    public function __construct($app)
    {
        ...
        if('redis' == strtolower($config->{'snap.cache.type'})) {
            $this->cacher = $app->getCacher();
        } else {
            throw new \Exception(__CLASS__ . " only supports redis cacher type");
        }
    }
     ...
     * @param  String  $queueName    Name of the queue
     */
    public function empty($queueName)
    {

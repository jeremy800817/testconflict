 ...
 * @property            string              $code               The code to represent this bank
 * @property            string              $name               The name of this bank
 * @property            int                 $status             The status for this Bank object.  (Active / Inactive)
 ...
 */
class MyBank extends SnapObject
{

 ...
 * @property            string              $code                   The occupation category
 ...
 * @property            int                 $occupationCategoryId   The id for the main occupationcategory.
 * @property            int                 $politicallyExposed     The status for whether the user is pep  (Yes / No)
 ...
 */
class MyOccupationSubCategory extends MyLocalizedObject
{
    ...
    {
        return MyLocalizedContent::TYPE_OCCUPATIONSUBCATEGORY;
    }

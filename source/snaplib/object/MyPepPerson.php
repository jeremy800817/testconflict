 ...
 * @property            int             $personid           The person id from provider 
 * @property            string          $file               The file content 
 * @property            enum            $type               The type of file, PDF or JSON
 ...
 * @author Azam
 * @version 1.0
 * @created 2020/12/07 5:13 PM
 */
class MyPepPerson extends SnapObject
{
    ...
    public function isValid()
    {
        ...
        $this->validateRequiredField($this->members['personid'], 'personid');
        $this->validateRequiredField($this->members['file'], 'file');

...
* @package  snap.store
*/
class cachedatastore implements IEntityStore
{
    Use \Snap\TLogging;
    ...
    {
        return $this->systemCachePrefix  . '_' . $this->tableName . '_' . $id;
    }
    ...
    {
        return $this->systemCachePrefix  . '_' . $this->tableName . '_' . $id . ':lock';
    }
    ...
    {
        return $this->systemCachePrefix  . '_' . $this->tableName . ':Index';
    }
